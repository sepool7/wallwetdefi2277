...
const pushTransaction = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const payload = yield api.sendRawTransaction(Buffer.from(rawTx, 'hex'));
    return {
...
const getAccountInfo = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const getTransactionPage = (txIds, tokenAccountsInfos) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        return (yield Promise.all(transactionsPage
            .filter(isValidTransaction)
            .map(tx => blockchain_link_utils_1.solanaUtils.transformTransaction(tx, payload.descriptor, tokenAccountsInfos)))).filter((tx) => !!tx);
    });
    ...
    if (tokenAccounts.value.length > 0) {
        const tokenMetadata = yield blockchain_link_utils_1.solanaUtils.getTokenMetadata();
...
const estimateFee = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const api = yield request.connect();
    const message = (_a = request.payload.specific) === null || _a === void 0 ? void 0 : _a.data;
    ...
    const result = yield api.getFeeForMessage(web3_js_1.Message.from(Buffer.from(message, 'hex')));
...
const subscribeBlock = ({ state, connect, post }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
const subscribeAccounts = ({ connect, state, post }, accounts) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield connect();
    ...
    newAccounts.forEach(a => {
        const subscriptionId = api.onAccountChange(new web3_js_1.PublicKey(a.descriptor), () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            const tx = yield blockchain_link_utils_1.solanaUtils.transformTransaction(lastTx, a.descriptor, []);
...
const unsubscribeAccounts = ({ state, connect }, accounts = []) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield connect();
    const subscribedAccounts = state.getAccounts();
    accounts.forEach(a => {
        var _a;
