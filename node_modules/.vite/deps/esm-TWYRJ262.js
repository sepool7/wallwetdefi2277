...
var init_es = __esm({
  "node_modules/detect-browser/es/index.js"() {
    __spreadArrays = function() {
      for (var s3 = 0, i5 = 0, il = arguments.length; i5 < il; i5++)
        s3 += arguments[i5].length;
      for (var r3 = Array(s3), k5 = 0, i5 = 0; i5 < il; i5++)
    ...
    exports.getPositions = function getPositions(version2) {
      ...
      for (var i5 = 0; i5 < posLength; i5++) {
        for (var j5 = 0; j5 < posLength; j5++) {
          if (i5 === 0 && j5 === 0 || // top-left
          i5 === 0 && j5 === posLength - 1 || // bottom-left
          i5 === posLength - 1 && j5 === 0) {
            continue;
          }
...
var require_buffer = __commonJS({
  "node_modules/qrcode/node_modules/buffer/index.js"(exports) {
    ...
    Buffer2.compare = function compare2(a5, b5) {
      ...
      var x5 = a5.length;
      var y6 = b5.length;
      for (var i5 = 0, len = Math.min(x5, y6); i5 < len; ++i5) {
        if (a5[i5] !== b5[i5]) {
          x5 = a5[i5];
          y6 = b5[i5];
          break;
    ...
    var hexSliceLookupTable = function() {
      ...
      for (var i5 = 0; i5 < 16; ++i5) {
        ...
        for (var j5 = 0; j5 < 16; ++j5) {
          table[i16 + j5] = alphabet2[i5] + alphabet2[j5];
        }
      }
      return table;
    }();
      ...
      for (var i5 = 0; i5 < pos.length; i5++) {
        ...
        for (var r3 = -1; r3 <= 7; r3++) {
          ...
          for (var c6 = -1; c6 <= 7; c6++) {
            if (col + c6 <= -1 || size <= col + c6)
              continue;
            if (r3 >= 0 && r3 <= 6 && (c6 === 0 || c6 === 6) || c6 >= 0 && c6 <= 6 && (r3 === 0 || r3 === 6) || r3 >= 2 && r3 <= 4 && c6 >= 2 && c6 <= 4) {
              matrix.set(row + r3, col + c6, true, true);
            } else {
              matrix.set(row + r3, col + c6, false, true);
            }
          }
        }
      }
    ...
    function setupAlignmentPattern(matrix, version2) {
      ...
      for (var i5 = 0; i5 < pos.length; i5++) {
        ...
        for (var r3 = -2; r3 <= 2; r3++) {
          for (var c6 = -2; c6 <= 2; c6++) {
            if (r3 === -2 || r3 === 2 || c6 === -2 || c6 === 2 || r3 === 0 && c6 === 0) {
              matrix.set(row + r3, col + c6, true, true);
            } else {
              matrix.set(row + r3, col + c6, false, true);
            }
      ...
      for (var col = size - 1; col > 0; col -= 2) {
        ...
        while (true) {
          for (var c6 = 0; c6 < 2; c6++) {
            if (!matrix.isReserved(row, col - c6)) {
              var dark = false;
              if (byteIndex < data.length) {
                dark = (data[byteIndex] >>> bitIndex & 1) === 1;
              }
              matrix.set(row, col - c6, dark);
              bitIndex--;
              if (bitIndex === -1) {
                byteIndex++;
                bitIndex = 7;
  ...
  "node_modules/qrcode/lib/renderer/utils.js"(exports) {
    function hex2rgba(hex) {
      ...
      if (hexCode.length === 3 || hexCode.length === 4) {
        hexCode = Array.prototype.concat.apply([], hexCode.map(function(c6) {
          return [c6, c6];
        }));
      }
      if (hexCode.length === 6)
...
function h(n3, l4, u5) {
  var i5, t3 = arguments, r3 = {};
  for (i5 in l4)
    "key" !== i5 && "ref" !== i5 && (r3[i5] = l4[i5]);
  ...
  if (null != u5 && (r3.children = u5), "function" == typeof n3 && null != n3.defaultProps)
    for (i5 in n3.defaultProps)
      void 0 === r3[i5] && (r3[i5] = n3.defaultProps[i5]);
  return p(n3, r3, l4 && l4.key, l4 && l4.ref, null);
}
function p(l4, u5, i5, t3, r3) {
  var o3 = { type: l4, props: u5, key: i5, ref: t3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: r3 };
...
function _() {
  for (var n3; i = u.length; )
    n3 = u.sort(function(n4, l4) {
      ...
      var l4, u5, i5, t3, r3, o3, f4;
      n4.__d && (o3 = (r3 = (l4 = n4).__v).__e, (f4 = l4.__P) && (u5 = [], (i5 = a({}, r3)).__v = i5, t3 = A(f4, r3, i5, l4.__n, void 0 !== f4.ownerSVGElement, null, u5, null == o3 ? w(r3) : o3), T(u5, r3), t3 != o3 && k(r3)));
    });
}
function b(n3, l4, u5, i5, t3, r3, o3, f4, s3) {
  var a5, h6, p5, y6, d4, m4, k5, g7 = u5 && u5.__k || c, _6 = g7.length;
  if (f4 == e && (f4 = null != r3 ? r3[0] : _6 ? w(u5, 0) : null), a5 = 0, l4.__k = x(l4.__k, function(u6) {
    if (null != u6) {
      if (u6.__ = l4, u6.__b = l4.__b + 1, null === (p5 = g7[a5]) || p5 && u6.key == p5.key && u6.type === p5.type)
        g7[a5] = void 0;
      else
        for (h6 = 0; h6 < _6; h6++) {
      ...
      if (y6 = A(n3, u6, p5 = p5 || e, i5, t3, r3, o3, f4, s3), (h6 = u6.ref) && p5.ref != h6 && (k5 || (k5 = []), p5.ref && k5.push(p5.ref, null, u6), k5.push(h6, u6.__c || y6, u6)), null != y6) {
        var c6;
        if (null == m4 && (m4 = y6), void 0 !== u6.__d)
          c6 = u6.__d, u6.__d = void 0;
        else if (r3 == p5 || y6 != f4 || null == y6.parentNode) {
          n:
            if (null == f4 || f4.parentNode !== n3)
              n3.appendChild(y6), c6 = null;
            else {
              for (d4 = f4, h6 = 0; (d4 = d4.nextSibling) && h6 < _6; h6 += 2)
                if (d4 == y6)
                  break n;
              n3.insertBefore(y6, f4), c6 = f4;
            }
          "option" == l4.type && (n3.value = "");
        }
        f4 = void 0 !== c6 ? c6 : y6.nextSibling, "function" == typeof l4.type && (l4.__d = f4);
      } else
        f4 && p5.__e == f4 && f4.parentNode != n3 && (f4 = w(p5));
    }
    return a5++, u6;
  }), l4.__e = m4, null != r3 && "function" != typeof l4.type)
    for (a5 = r3.length; a5--; )
      null != r3[a5] && v(r3[a5]);
  for (a5 = _6; a5--; )
    null != g7[a5] && D(g7[a5], g7[a5]);
  if (k5)
...
function x(n3, l4, u5) {
  if (null == u5 && (u5 = []), null == n3 || "boolean" == typeof n3)
    ...
    u5.push(l4 ? l4("string" == typeof n3 || "number" == typeof n3 ? p(null, n3, null, null, n3) : null != n3.__e || null != n3.__c ? p(n3.type, n3.props, n3.key, null, n3.__v) : n3) : n3);
  return u5;
}
function P(n3, l4, u5, i5, t3) {
  var r3;
  for (r3 in u5)
    "children" === r3 || "key" === r3 || r3 in l4 || N(n3, r3, null, u5[r3], i5);
  for (r3 in l4)
    t3 && "function" != typeof l4[r3] || "children" === r3 || "key" === r3 || "value" === r3 || "checked" === r3 || u5[r3] === l4[r3] || N(n3, r3, l4[r3], u5[r3], i5);
}
function C(n3, l4, u5) {
  "-" === l4[0] ? n3.setProperty(l4, u5) : n3[l4] = "number" == typeof u5 && false === s.test(l4) ? u5 + "px" : null == u5 ? "" : u5;
}
function N(n3, l4, u5, i5, t3) {
  var r3, o3, f4, e3, c6;
  if (t3 ? "className" === l4 && (l4 = "class") : "class" === l4 && (l4 = "className"), "style" === l4)
    if (r3 = n3.style, "string" == typeof u5)
      r3.cssText = u5;
    else {
      if ("string" == typeof i5 && (r3.cssText = "", i5 = null), i5)
        for (e3 in i5)
          u5 && e3 in u5 || C(r3, e3, "");
      if (u5)
        for (c6 in u5)
          i5 && u5[c6] === i5[c6] || C(r3, c6, u5[c6]);
    }
  else
    "o" === l4[0] && "n" === l4[1] ? (o3 = l4 !== (l4 = l4.replace(/Capture$/, "")), f4 = l4.toLowerCase(), l4 = (f4 in n3 ? f4 : l4).slice(2), u5 ? (i5 || n3.addEventListener(l4, z, o3), (n3.l || (n3.l = {}))[l4] = u5) : n3.removeEventListener(l4, z, o3)) : "list" !== l4 && "tagName" !== l4 && "form" !== l4 && "type" !== l4 && "size" !== l4 && !t3 && l4 in n3 ? n3[l4] = null == u5 ? "" : u5 : "function" != typeof u5 && "dangerouslySetInnerHTML" !== l4 && (l4 !== (l4 = l4.replace(/^xlink:?/, "")) ? null == u5 || false === u5 ? n3.removeAttributeNS("http://www.w3.org/1999/xlink", l4.toLowerCase()) : n3.setAttributeNS("http://www.w3.org/1999/xlink", l4.toLowerCase(), u5) : null == u5 || false === u5 && !/^ar/.test(l4) ? n3.removeAttribute(l4) : n3.setAttribute(l4, u5));
}
function z(l4) {
  this.l[l4.type](n.event ? n.event(l4) : l4);
}
function A(l4, u5, i5, t3, r3, o3, f4, e3, c6) {
  var s3, v5, h6, p5, y6, w8, k5, g7, _6, x5, P4 = u5.type;
  ...
  try {
    n:
      if ("function" == typeof P4) {
        if (g7 = u5.props, _6 = (s3 = P4.contextType) && t3[s3.__c], x5 = s3 ? _6 ? _6.props.value : s3.__ : t3, i5.__c ? k5 = (v5 = u5.__c = i5.__c).__ = v5.__E : ("prototype" in P4 && P4.prototype.render ? u5.__c = v5 = new P4(g7, x5) : (u5.__c = v5 = new m(g7, x5), v5.constructor = P4, v5.render = E), _6 && _6.sub(v5), v5.props = g7, v5.state || (v5.state = {}), v5.context = x5, v5.__n = t3, h6 = v5.__d = true, v5.__h = []), null == v5.__s && (v5.__s = v5.state), null != P4.getDerivedStateFromProps && (v5.__s == v5.state && (v5.__s = a({}, v5.__s)), a(v5.__s, P4.getDerivedStateFromProps(g7, v5.__s))), p5 = v5.props, y6 = v5.state, h6)
          ...
          if (null == P4.getDerivedStateFromProps && g7 !== p5 && null != v5.componentWillReceiveProps && v5.componentWillReceiveProps(g7, x5), !v5.__e && null != v5.shouldComponentUpdate && false === v5.shouldComponentUpdate(g7, v5.__s, x5) || u5.__v === i5.__v && !v5.__) {
            for (v5.props = g7, v5.state = v5.__s, u5.__v !== i5.__v && (v5.__d = false), v5.__v = u5, u5.__e = i5.__e, u5.__k = i5.__k, v5.__h.length && f4.push(v5), s3 = 0; s3 < u5.__k.length; s3++)
        ...
        v5.context = x5, v5.props = g7, v5.state = v5.__s, (s3 = n.__r) && s3(u5), v5.__d = false, v5.__v = u5, v5.__P = l4, s3 = v5.render(v5.props, v5.state, v5.context), u5.__k = null != s3 && s3.type == d && null == s3.key ? s3.props.children : Array.isArray(s3) ? s3 : [s3], null != v5.getChildContext && (t3 = a(a({}, t3), v5.getChildContext())), h6 || null == v5.getSnapshotBeforeUpdate || (w8 = v5.getSnapshotBeforeUpdate(p5, y6)), b(l4, u5, i5, t3, r3, o3, f4, e3, c6), v5.base = u5.__e, v5.__h.length && f4.push(v5), k5 && (v5.__E = v5.__ = null), v5.__e = false;
      } else
        null == o3 && u5.__v === i5.__v ? (u5.__k = i5.__k, u5.__e = i5.__e) : u5.__e = $(i5.__e, u5, i5, t3, r3, o3, f4, c6);
    (s3 = n.diffed) && s3(u5);
  } catch (l5) {
    u5.__v = null, n.__e(l5, u5, i5);
  }
  return u5.__e;
}
function T(l4, u5) {
  n.__c && n.__c(u5, l4), l4.some(function(u6) {
    try {
      l4 = u6.__h, u6.__h = [], l4.some(function(n3) {
        n3.call(u6);
      });
    } catch (l5) {
      n.__e(l5, u6.__v);
...
function $(n3, l4, u5, i5, t3, r3, o3, f4) {
  var s3, a5, v5, h6, p5, y6 = u5.props, d4 = l4.props;
  if (t3 = "svg" === l4.type || t3, null != r3) {
    for (s3 = 0; s3 < r3.length; s3++)
      if (null != (a5 = r3[s3]) && ((null === l4.type ? 3 === a5.nodeType : a5.localName === l4.type) || n3 == a5)) {
        n3 = a5, r3[s3] = null;
        break;
      }
  }
  if (null == n3) {
    ...
    n3 = t3 ? document.createElementNS("http://www.w3.org/2000/svg", l4.type) : document.createElement(l4.type, d4.is && { is: d4.is }), r3 = null, f4 = false;
  }
  if (null === l4.type)
    y6 !== d4 && n3.data != d4 && (n3.data = d4);
  else {
    if (null != r3 && (r3 = c.slice.call(n3.childNodes)), v5 = (y6 = u5.props || e).dangerouslySetInnerHTML, h6 = d4.dangerouslySetInnerHTML, !f4) {
      if (y6 === e)
    ...
    P(n3, d4, y6, t3, f4), h6 ? l4.__k = [] : (l4.__k = l4.props.children, b(n3, l4, u5, i5, "foreignObject" !== l4.type && t3, r3, o3, e, f4)), f4 || ("value" in d4 && void 0 !== (s3 = d4.value) && s3 !== n3.value && N(n3, "value", s3, y6.value, false), "checked" in d4 && void 0 !== (s3 = d4.checked) && s3 !== n3.checked && N(n3, "checked", s3, y6.checked, false));
  }
  return n3;
}
function j(l4, u5, i5) {
...
function D(l4, u5, i5) {
  var t3, r3, o3;
  if (n.unmount && n.unmount(l4), (t3 = l4.ref) && (t3.current && t3.current !== l4.__e || j(t3, null, u5)), i5 || "function" == typeof l4.type || (i5 = null != (r3 = l4.__e)), l4.__e = l4.__d = void 0, null != (t3 = l4.__c)) {
...
function H(l4, u5, i5) {
  var t3, r3, f4;
  n.__ && n.__(l4, u5), r3 = (t3 = i5 === o) ? null : i5 && i5.__k || u5.__k, l4 = h(d, null, [l4]), f4 = [], A(u5, (t3 ? u5 : i5 || u5).__k = l4, r3 || e, e, void 0 !== u5.ownerSVGElement, i5 && !t3 ? [i5] : r3 ? null : c.slice.call(u5.childNodes), f4, i5 || e, t3), T(f4, l4);
}
function I(n3, l4) {
  H(n3, l4, o);
}
function L(n3, l4) {
  var u5, i5;
  for (i5 in l4 = a(a({}, n3.props), l4), arguments.length > 2 && (l4.children = c.slice.call(arguments, 2)), u5 = {}, l4)
    "key" !== i5 && "ref" !== i5 && (u5[i5] = l4[i5]);
  return p(n3.type, u5, l4.key || n3.key, l4.ref || n3.ref, null);
}
function M(n3) {
  var l4 = {}, u5 = { __c: "__cC" + f++, __: n3, Consumer: function(n4, l5) {
    ...
    return this.getChildContext || (i5 = [], this.getChildContext = function() {
      ...
      t3.props.value !== n5.value && i5.some(function(l5) {
      ...
      n5.componentWillUnmount = function() {
        i5.splice(i5.indexOf(n5), 1), l5 && l5.call(n5);
      };
    }), n4.children;
  } };
...
var init_preact_module = __esm({
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = { __e: function(n3, l4) {
      ...
      var u5;
      u5 = this.__s !== this.state ? this.__s : this.__s = a({}, this.state), "function" == typeof n3 && (n3 = n3(u5, this.props)), n3 && a(u5, n3), null != n3 && this.__v && (l4 && this.__h.push(l4), g(this));
...
function p2(n3, r3, i5) {
  var o3 = v2(t2++, 2);
  return o3.__c || (o3.__c = u2, o3.__ = [i5 ? i5(r3) : E2(void 0, r3), function(t3) {
...
function l2(r3, i5) {
  var o3 = v2(t2++, 3);
  !n.__s && x2(o3.__H, i5) && (o3.__ = r3, o3.__H = i5, u2.__H.__h.push(o3));
}
function y2(r3, i5) {
  var o3 = v2(t2++, 4);
  !n.__s && x2(o3.__H, i5) && (o3.__ = r3, o3.__H = i5, u2.__h.push(o3));
}
function d2(n3) {
...
function w2(n3) {
  var r3 = u2.context[n3.__c], i5 = v2(t2++, 9);
  return i5.__c = n3, r3 ? (null == i5.__ && (i5.__ = true, r3.sub(u2)), r3.props.value) : n3.__;
}
function A2(t3, u5) {
  n.useDebugValue && n.useDebugValue(u5 ? u5(t3) : t3);
}
function F(n3) {
  var r3 = v2(t2++, 10), i5 = m2();
  return r3.__ = n3, u2.componentDidCatch || (u2.componentDidCatch = function(n4) {
    r3.__ && r3.__(n4), i5[1](n4);
  }), [i5[0], function() {
    i5[1](void 0);
  }];
}
...
function x2(n3, t3) {
  return !n3 || t3.some(function(t4, u5) {
    return t4 !== n3[u5];
  });
}
function E2(n3, t3) {
...
var init_hooks_module = __esm({
  "node_modules/preact/hooks/dist/hooks.module.js"() {
    ...
    n.__r = function(n3) {
      ...
      if (u5) {
        var i5 = u5.__H;
        i5 && i5.__h.length && (1 !== o2.push(u5) && r2 === n.requestAnimationFrame || ((r2 = n.requestAnimationFrame) || function(n3) {
          var t4, u6 = function() {
...
var init_compat_module = __esm({
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    n.__e = function(n3, t3, e3) {
      ...
      var r3 = M2(e3.__v), o3 = false, u5 = function() {
        o3 || (o3 = true, r3 ? r3(i5) : i5());
      };
    ...
    n.vnode = function(n3) {
      ...
      if (t3) {
        if (e3.class != e3.className && ($2.enumerable = "className" in e3, null != e3.className && (e3.class = e3.className), Object.defineProperty(e3, "className", $2)), "function" != typeof t3) {
          var r3, o3, u5;
          for (u5 in e3.defaultValue && void 0 !== e3.value && (e3.value || 0 === e3.value || (e3.value = e3.defaultValue), delete e3.defaultValue), Array.isArray(e3.value) && e3.multiple && "select" === t3 && (x(e3.children).forEach(function(n4) {
        ...
        !function(t4) {
          ...
          if (r4 && "string" == typeof e4) {
            var o4 = {};
            for (var u6 in r4)
              /^on(Ani|Tra|Tou)/.test(u6) && (r4[u6.toLowerCase()] = r4[u6], delete r4[u6]), o4[u6.toLowerCase()] = u6;
            if (o4.ondoubleclick && (r4.ondblclick = r4[o4.ondoubleclick], delete r4[o4.ondoubleclick]), o4.onbeforeinput && (r4.onbeforeinput = r4[o4.onbeforeinput], delete r4[o4.onbeforeinput]), o4.onchange && ("textarea" === e4 || "input" === e4.toLowerCase() && !/^fil|che|ra/i.test(r4.type))) {
              var i5 = o4.oninput || "oninput";
              r4[i5] || (r4[i5] = r4[o4.onchange], delete r4[o4.onchange]);
            }
          }
...
function __rest(s3, e3) {
  var t3 = {};
  for (var p5 in s3)
    if (Object.prototype.hasOwnProperty.call(s3, p5) && e3.indexOf(p5) < 0)
      t3[p5] = s3[p5];
  if (s3 != null && typeof Object.getOwnPropertySymbols === "function")
    for (var i5 = 0, p5 = Object.getOwnPropertySymbols(s3); i5 < p5.length; i5++) {
      if (e3.indexOf(p5[i5]) < 0 && Object.prototype.propertyIsEnumerable.call(s3, p5[i5]))
        t3[p5[i5]] = s3[p5[i5]];
    }
  return t3;
}
function __decorate(decorators, target, key, desc) {
  ...
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function")
    ...
    for (var i5 = decorators.length - 1; i5 >= 0; i5--)
      if (d4 = decorators[i5])
        r3 = (c6 < 3 ? d4(r3) : c6 > 3 ? d4(target, key, r3) : d4(target, key)) || r3;
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_6)
      try {
        if (f4 = 1, y6 && (t3 = op[0] & 2 ? y6["return"] : op[0] ? y6["throw"] || ((t3 = y6["return"]) && t3.call(y6), 0) : y6.next) && !(t3 = t3.call(y6, op[1])).done)
          return t3;
        if (y6 = 0, t3)
          op = [op[0] & 2, t3.value];
        switch (op[0]) {
...
function __values(o3) {
  var s3 = typeof Symbol === "function" && Symbol.iterator, m4 = s3 && o3[s3], i5 = 0;
  if (m4)
    return m4.call(o3);
...
function __read(o3, n3) {
  ...
  if (!m4)
    return o3;
  var i5 = m4.call(o3), r3, ar2 = [], e3;
  try {
    while ((n3 === void 0 || n3-- > 0) && !(r3 = i5.next()).done)
      ar2.push(r3.value);
  } catch (error) {
    e3 = { error };
  } finally {
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  var g7 = generator.apply(thisArg, _arguments || []), i5, q4 = [];
...
function __asyncValues(o3) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var m4 = o3[Symbol.asyncIterator], i5;
  return m4 ? m4.call(o3) : (o3 = typeof __values === "function" ? __values(o3) : o3[Symbol.iterator](), i5 = {}, verb("next"), verb("throw"), verb("return"), i5[Symbol.asyncIterator] = function() {
    return this;
  }, i5);
  function verb(n3) {
    i5[n3] = o3[n3] && function(v5) {
...
function __createBinding2(o3, m4, k5, k22) {
  if (k22 === void 0)
    k22 = k5;
  o3[k22] = m4[k5];
}
...
function __asyncDelegator2(o3) {
  ...
  function verb(n3, f4) {
    i5[n3] = o3[n3] ? function(v5) {
      return (p5 = !p5) ? { value: __await2(o3[n3](v5)), done: n3 === "return" } : f4 ? f4(v5) : v5;
    } : f4;
  }
}
function __asyncValues2(o3) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var m4 = o3[Symbol.asyncIterator], i5;
  return m4 ? m4.call(o3) : (o3 = typeof __values2 === "function" ? __values2(o3) : o3[Symbol.iterator](), i5 = {}, verb("next"), verb("throw"), verb("return"), i5[Symbol.asyncIterator] = function() {
    return this;
  }, i5);
  function verb(n3) {
    i5[n3] = o3[n3] && function(v5) {
...
function __extends3(d4, b5) {
  extendStatics3(d4, b5);
  function __() {
    this.constructor = d4;
  }
  d4.prototype = b5 === null ? Object.create(b5) : (__.prototype = b5.prototype, new __());
...
function __createBinding3(o3, m4, k5, k22) {
  if (k22 === void 0)
    k22 = k5;
  o3[k22] = m4[k5];
}
...
function __spread3() {
  for (var ar2 = [], i5 = 0; i5 < arguments.length; i5++)
    ar2 = ar2.concat(__read3(arguments[i5]));
  return ar2;
}
...
function __asyncDelegator3(o3) {
  ...
  function verb(n3, f4) {
    i5[n3] = o3[n3] ? function(v5) {
      return (p5 = !p5) ? { value: __await3(o3[n3](v5)), done: n3 === "return" } : f4 ? f4(v5) : v5;
    } : f4;
  }
}
function __asyncValues3(o3) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var m4 = o3[Symbol.asyncIterator], i5;
  return m4 ? m4.call(o3) : (o3 = typeof __values3 === "function" ? __values3(o3) : o3[Symbol.iterator](), i5 = {}, verb("next"), verb("throw"), verb("return"), i5[Symbol.asyncIterator] = function() {
    return this;
  }, i5);
  function verb(n3) {
    i5[n3] = o3[n3] && function(v5) {
...
var init_tslib_es63 = __esm({
  "node_modules/@walletconnect/logger/node_modules/tslib/tslib.es6.js"() {
    extendStatics3 = function(d4, b5) {
      extendStatics3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d5, b6) {
        d5.__proto__ = b6;
      } || function(d5, b6) {
        for (var p5 in b6)
          if (b6.hasOwnProperty(p5))
  ...
  "node_modules/quick-format-unescaped/index.js"(exports, module) {
    ...
    function format(f4, args, opts) {
      ...
      for (var i5 = 0; i5 < flen; ) {
        if (f4.charCodeAt(i5) === 37 && i5 + 1 < flen) {
          lastPos = lastPos > -1 ? lastPos : 0;
          switch (f4.charCodeAt(i5 + 1)) {
            case 100:
            case 102:
              if (a5 >= argLen)
                break;
  ...
  "node_modules/@stablelib/sha512/lib/sha512.js"(exports) {
    ...
    function hashBlocks(wh, wl, hh, hl, m4, pos, len) {
      ...
      while (len >= 128) {
        for (var i5 = 0; i5 < 16; i5++) {
          var j5 = 8 * i5 + pos;
          wh[i5] = binary_1.readUint32BE(m4, j5);
          wl[i5] = binary_1.readUint32BE(m4, j5 + 4);
        }
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function pack25519(o3, n3) {
      ...
      for (let j5 = 0; j5 < 2; j5++) {
        ...
        for (let i5 = 1; i5 < 15; i5++) {
          m4[i5] = t3[i5] - 65535 - (m4[i5 - 1] >> 16 & 1);
          m4[i5 - 1] &= 65535;
        }
    ...
    function edadd(p5, q4) {
      const a5 = gf(), b5 = gf(), c6 = gf(), d4 = gf(), e3 = gf(), f4 = gf(), g7 = gf(), h6 = gf(), t3 = gf();
      sub(a5, p5[1], p5[0]);
      sub(t3, q4[1], q4[0]);
      mul(a5, a5, t3);
      add(b5, p5[0], p5[1]);
    ...
    function modL(r3, x5) {
      ...
      for (i5 = 63; i5 >= 32; --i5) {
        carry = 0;
        for (j5 = i5 - 32, k5 = i5 - 12; j5 < k5; ++j5) {
          x5[j5] += carry - 16 * x5[i5] * L6[j5 - (i5 - 32)];
  ...
  "node_modules/@stablelib/chacha/lib/chacha.js"(exports) {
    ...
    function streamXOR(key, nonce, src2, dst, nonceInplaceCounterLength) {
      ...
      for (var i5 = 0; i5 < src2.length; i5 += 64) {
        core(block, nc, key);
        for (var j5 = i5; j5 < i5 + 64 && j5 < src2.length; j5++) {
          dst[j5] = src2[j5] ^ block[j5 - i5];
        }
    ...
    var Poly1305 = (
      ...
      function() {
        ...
        Poly13052.prototype.finish = function(mac, macpos) {
          ...
          mask = ~mask;
          for (i5 = 0; i5 < 10; i5++) {
            this._h[i5] = this._h[i5] & mask | g7[i5];
          }
          ...
          this._h[0] = f4 & 65535;
          for (i5 = 1; i5 < 8; i5++) {
            f4 = (this._h[i5] + this._pad[i5] | 0) + (f4 >>> 16) | 0;
            this._h[i5] = f4 & 65535;
          }
        ...
        Poly13052.prototype.update = function(m4) {
          ...
          if (this._leftover) {
            ...
            for (var i5 = 0; i5 < want; i5++) {
              this._buffer[this._leftover + i5] = m4[mpos + i5];
            }
            bytes -= want;
            mpos += want;
            this._leftover += want;
  ...
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w8, v5, p5, pos, len) {
      while (len >= 64) {
        ...
        for (var i5 = 0; i5 < 16; i5++) {
          var j5 = pos + i5 * 4;
          w8[i5] = binary_1.readUint32BE(p5, j5);
        }
        for (var i5 = 16; i5 < 64; i5++) {
          ...
          w8[i5] = (t1 + w8[i5 - 7] | 0) + (t22 + w8[i5 - 16] | 0);
        }
        for (var i5 = 0; i5 < 64; i5++) {
          var t1 = (((e3 >>> 6 | e3 << 32 - 6) ^ (e3 >>> 11 | e3 << 32 - 11) ^ (e3 >>> 25 | e3 << 32 - 25)) + (e3 & f4 ^ ~e3 & g7) | 0) + (h6 + (K4[i5] + w8[i5] | 0) | 0) | 0;
          var t22 = ((a5 >>> 2 | a5 << 32 - 2) ^ (a5 >>> 13 | a5 << 32 - 13) ^ (a5 >>> 22 | a5 << 32 - 22)) + (a5 & b5 ^ a5 & c6 ^ b5 & c6) | 0;
          h6 = g7;
          g7 = f4;
          f4 = e3;
          e3 = d4 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n3, p5) {
      ...
      const a5 = gf(), b5 = gf(), c6 = gf(), d4 = gf(), e3 = gf(), f4 = gf();
  ...
  "node_modules/query-string/index.js"(exports) {
    ...
    function keysSorter(input) {
      ...
      if (typeof input === "object") {
        return keysSorter(Object.keys(input)).sort((a5, b5) => Number(a5) - Number(b5)).map((key) => input[key]);
      }
      return input;
    }
...
function __extends4(d4, b5) {
  extendStatics4(d4, b5);
  function __() {
    this.constructor = d4;
  }
  d4.prototype = b5 === null ? Object.create(b5) : (__.prototype = b5.prototype, new __());
...
function __createBinding4(o3, m4, k5, k22) {
  if (k22 === void 0)
    k22 = k5;
  o3[k22] = m4[k5];
}
...
function __spread4() {
  for (var ar2 = [], i5 = 0; i5 < arguments.length; i5++)
    ar2 = ar2.concat(__read4(arguments[i5]));
  return ar2;
}
...
function __asyncGenerator4(thisArg, _arguments, generator) {
  ...
  function step(r3) {
    r3.value instanceof __await4 ? Promise.resolve(r3.value.v).then(fulfill, reject) : settle(q4[0][2], r3);
  }
  function fulfill(value) {
    resume("next", value);
  }
...
function __asyncDelegator4(o3) {
  ...
  function verb(n3, f4) {
    i5[n3] = o3[n3] ? function(v5) {
      return (p5 = !p5) ? { value: __await4(o3[n3](v5)), done: n3 === "return" } : f4 ? f4(v5) : v5;
    } : f4;
  }
}
function __asyncValues4(o3) {
  if (!Symbol.asyncIterator)
    throw new TypeError("Symbol.asyncIterator is not defined.");
  var m4 = o3[Symbol.asyncIterator], i5;
  return m4 ? m4.call(o3) : (o3 = typeof __values4 === "function" ? __values4(o3) : o3[Symbol.iterator](), i5 = {}, verb("next"), verb("throw"), verb("return"), i5[Symbol.asyncIterator] = function() {
    return this;
  }, i5);
  function verb(n3) {
    i5[n3] = o3[n3] && function(v5) {
...
var init_tslib_es64 = __esm({
  "node_modules/@walletconnect/environment/node_modules/tslib/tslib.es6.js"() {
    extendStatics4 = function(d4, b5) {
      extendStatics4 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d5, b6) {
        d5.__proto__ = b6;
      } || function(d5, b6) {
        for (var p5 in b6)
          if (b6.hasOwnProperty(p5))
...
function unfetch_module_default(e3, n3) {
  return n3 = n3 || {}, new Promise(function(t3, r3) {
    var s3 = new XMLHttpRequest(), o3 = [], u5 = [], i5 = {}, a5 = function() {
      ...
      }, clone: a5, headers: { keys: function() {
        return o3;
      }, entries: function() {
        return u5;
      }, get: function(e4) {
        return i5[e4.toLowerCase()];
      }, has: function(e4) {
        return e4.toLowerCase() in i5;
      } } };
    };
    for (var l4 in s3.open(n3.method || "get", e3, true), s3.onload = function() {
      s3.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e4, n4, t4) {
        o3.push(n4 = n4.toLowerCase()), u5.push([n4, t4]), i5[n4] = i5[n4] ? i5[n4] + "," + t4 : t4;
      }), t3(a5());
...
var x3 = "idb-keyval";
var z3 = (i5 = {}) => {
  const t3 = i5.base && i5.base.length > 0 ? `${i5.base}:` : "", e3 = (s3) => t3 + s3;
  let n3;
  return i5.dbName && i5.storeName && (n3 = createStore(i5.dbName, i5.storeName)), { name: x3, options: i5, async hasItem(s3) {
...
(function() {
  ...
  }, i5.prototype.setItem = function(e3, n3) {
    this[e3] = String(n3);
...
var y3 = 1;
var O2 = async (i5, t3, e3) => {
  const n3 = N3, s3 = await t3.getItem(n3);
  if (s3 && s3 >= y3) {
    e3(t3);
    return;
  }
  const a5 = await i5.getKeys();
  if (!a5.length) {
    e3(t3);
    return;
  }
  ...
  for (; a5.length; ) {
    ...
    if (o3.includes("wc@") || o3.includes("walletconnect") || o3.includes("wc_") || o3.includes("wallet_connect")) {
      const f4 = await i5.getItem(r3);
      await t3.setItem(r3, f4), m4.push(r3);
    }
  }
  await t3.setItem(n3, y3), e3(t3), j3(i5, m4);
};
var j3 = async (i5, t3) => {
...
function base(ALPHABET, name2) {
  ...
  function decodeUnsafe(source) {
    ...
    while (source[psz]) {
      ...
      var i6 = 0;
      for (var it3 = size - 1; (carry !== 0 || i6 < length2) && it3 !== -1; it3--, i6++) {
...
var alphabetBytesToChars = alphabet.reduce((p5, c6, i5) => {
  p5[i5] = c6;
  return p5;
}, []);
var alphabetCharsToBytes = alphabet.reduce((p5, c6, i5) => {
  p5[c6.codePointAt(0)] = i5;
  return p5;
}, []);
...
function encodeJSON(val) {
  return toString2(fromString2(safeJsonStringify5(val), JSON_ENCODING), JWT_ENCODING);
}
...
var __spreadArray = function(to, from3, pack) {
  if (pack || arguments.length === 2)
    for (var i5 = 0, l4 = from3.length, ar2; i5 < l4; i5++) {
      if (ar2 || !(i5 in from3)) {
        if (!ar2)
          ar2 = Array.prototype.slice.call(from3, 0, i5);
        ar2[i5] = from3[i5];
      }
    }
...
function detectOS3(ua) {
  for (var ii = 0, count = operatingSystemRules2.length; ii < count; ii++) {
    var _a = operatingSystemRules2[ii], os2 = _a[0], regex = _a[1];
    var match = regex.exec(ua);
    if (match) {
      return os2;
    }
...
function xn(e3) {
  ...
  const t3 = typeof e3.senderPublicKey < "u" ? fromString2(e3.senderPublicKey, p4) : void 0, r3 = typeof e3.iv < "u" ? fromString2(e3.iv, p4) : (0, import_random2.randomBytes)(Z2), o3 = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e3.symKey, p4)).seal(r3, fromString2(e3.message, H3));
...
function ee(e3) {
  const n3 = fromString2(e3, F3), t3 = n3.slice(Dn, Te), r3 = Te;
  if (j4(t3) === _5) {
    const d4 = r3 + X2, l4 = d4 + Z2, c6 = n3.slice(r3, d4), u5 = n3.slice(d4, l4), a5 = n3.slice(l4);
    return { type: t3, sealed: a5, iv: u5, senderPublicKey: c6 };
  }
  const o3 = r3 + Z2, s3 = n3.slice(r3, o3), i5 = n3.slice(o3);
  return { type: t3, sealed: i5, iv: s3 };
}
function Hn(e3, n3) {
  const t3 = ee(e3);
  return Ae({ type: j4(t3.type), senderPublicKey: typeof t3.senderPublicKey < "u" ? toString2(t3.senderPublicKey, p4) : void 0, receiverPublicKey: n3 == null ? void 0 : n3.receiverPublicKey });
}
function Ae(e3) {
...
var _e = (e3, n3, t3) => n3 in e3 ? Bn(e3, n3, { enumerable: true, configurable: true, writable: true, value: t3 }) : e3[n3] = t3;
var $e = (e3, n3) => {
  for (var t3 in n3 || (n3 = {}))
    Gn.call(n3, t3) && _e(e3, t3, n3[t3]);
  if (Ue)
    for (var t3 of Ue(n3))
      Wn.call(n3, t3) && _e(e3, t3, n3[t3]);
  return e3;
};
var Ce = "ReactNative";
...
function Jn() {
  var e3;
  try {
    return $3() && typeof global < "u" && typeof (global == null ? void 0 : global.Application) < "u" ? (e3 = global.Application) == null ? void 0 : e3.applicationId : void 0;
  } catch {
    return;
  }
}
...
function Xn({ protocol: e3, version: n3, relayUrl: t3, sdkVersion: r3, auth: o3, projectId: s3, useOnCloseEvent: i5, bundleId: d4 }) {
  const l4 = t3.split("?"), c6 = Ke(e3, n3, r3), u5 = { auth: o3, ua: c6, projectId: s3, useOnCloseEvent: i5 || void 0, origin: d4 || void 0 }, a5 = ke(l4[1] || "", u5);
  return l4[0] + "?" + a5;
}
function O3(e3, n3) {
...
function at(e3 = import_time2.FIVE_MINUTES, n3) {
  ...
  let r3, o3, s3;
  return { resolve: (i5) => {
    s3 && r3 && (clearTimeout(s3), r3(i5));
  }, reject: (i5) => {
    s3 && o3 && (clearTimeout(s3), o3(i5));
  }, done: () => new Promise((i5, d4) => {
    s3 = setTimeout(() => {
      d4(new Error(n3));
    }, t3), r3 = i5, o3 = d4;
  }) };
...
async function gt({ id: e3, topic: n3, wcDeepLink: t3 }) {
  try {
    ...
    const s3 = `${o3}/wc?requestId=${e3}&sessionTopic=${n3}`, i5 = R2();
    i5 === m3.browser ? s3.startsWith("https://") ? window.open(s3, "_blank", "noreferrer noopener") : window.open(s3, "_self", "noreferrer noopener") : i5 === m3.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s3);
  } catch (r3) {
    console.error(r3);
  }
}
...
var Be = (e3, n3, t3) => n3 in e3 ? bt(e3, n3, { enumerable: true, configurable: true, writable: true, value: t3 }) : e3[n3] = t3;
var It = (e3, n3) => {
  for (var t3 in n3 || (n3 = {}))
    St.call(n3, t3) && Be(e3, t3, n3[t3]);
  if (qe)
    for (var t3 of qe(n3))
      wt.call(n3, t3) && Be(e3, t3, n3[t3]);
  return e3;
};
...
function Ge(e3, n3 = "-") {
  ...
  return Object.keys(e3).forEach((o3) => {
    if (o3.startsWith(r3)) {
      const s3 = o3.replace(r3, ""), i5 = e3[o3];
      t3[s3] = i5;
    }
  }), t3;
}
function Pt(e3) {
  ...
  const n3 = e3.indexOf(":"), t3 = e3.indexOf("?") !== -1 ? e3.indexOf("?") : void 0, r3 = e3.substring(0, n3), o3 = e3.substring(n3 + 1, t3).split("@"), s3 = typeof t3 < "u" ? e3.substring(t3) : "", i5 = M3.parse(s3);
  return { protocol: r3, topic: We(o3[0]), version: parseInt(o3[1], 10), symKey: i5.symKey, relay: Ge(i5), expiryTimestamp: i5.expiryTimestamp ? parseInt(i5.expiryTimestamp, 10) : void 0 };
}
function We(e3) {
...
function Rt(e3) {
  return `${e3.protocol}:${e3.topic}@${e3.version}?` + M3.stringify(Tt(It({ symKey: e3.symKey }, ze(e3.relay)), { expiryTimestamp: e3.expiryTimestamp }));
}
function A4(e3) {
  const n3 = [];
...
function Mt(e3, n3) {
  ...
  let s3 = true;
  return O3(o3, r3) ? (r3.forEach((i5) => {
    const { accounts: d4, methods: l4, events: c6 } = e3.namespaces[i5], u5 = A4(d4), a5 = t3[i5];
    (!O3(L3(i5, a5), u5) || !O3(a5.methods, l4) || !O3(a5.events, c6)) && (s3 = false);
  }), s3) : false;
}
function V2(e3) {
...
function Ft(e3, n3) {
  let t3 = null;
  return g4(e3 == null ? void 0 : e3.publicKey, false) || (t3 = N10("MISSING_OR_INVALID", `${n3} controller public key should be a string`)), t3;
}
function ie(e3) {
  let n3 = true;
...
function on(e3, n3, t3) {
  let r3 = null;
  return k4(n3) && n3.length ? n3.forEach((o3) => {
    r3 || V2(o3) || (r3 = U2("UNSUPPORTED_CHAINS", `${t3}, chain ${o3} should be a string and conform to "namespace:chainId" format`));
  }) : V2(e3) || (r3 = U2("UNSUPPORTED_CHAINS", `${t3}, chains must be defined as "namespace:chainId" e.g. "eip155:1": {...} in the namespace key OR as an array of CAIP-2 chainIds e.g. eip155: { chains: ["eip155:1", "eip155:5"] }`)), r3;
}
function sn(e3, n3, t3) {
  ...
  return Object.entries(e3).forEach(([o3, s3]) => {
    if (r3)
      return;
    const i5 = on(o3, L3(o3, s3), `${n3} ${t3}`);
    i5 && (r3 = i5);
  }), r3;
}
function cn(e3, n3) {
  let t3 = null;
  return k4(e3) ? e3.forEach((r3) => {
    t3 || rn(r3) || (t3 = U2("UNSUPPORTED_ACCOUNTS", `${n3}, account ${r3} should be a string and conform to "namespace:chainId:address" format`));
...
function qt(e3, n3) {
  let t3 = false;
  return n3 && !e3 ? t3 = true : e3 && k4(e3) && e3.length && e3.forEach((r3) => {
    t3 = dn(r3);
  }), t3;
}
function Bt(e3) {
...
function zt(e3) {
  return !(w4(e3) || !g4(e3.method, false));
}
function Yt(e3) {
  return !(w4(e3) || w4(e3.result) && w4(e3.error) || !G2(e3.id, false) || !g4(e3.jsonrpc, false));
}
function Jt(e3) {
  return !(w4(e3) || !g4(e3.name, false));
}
function Qt(e3, n3) {
...
function fn(e3, n3, t3) {
  let r3 = null;
  const o3 = er(e3), s3 = nr(n3), i5 = Object.keys(o3), d4 = Object.keys(s3), l4 = pn(Object.keys(e3)), c6 = pn(Object.keys(n3)), u5 = l4.filter((a5) => !c6.includes(a5));
  return u5.length && (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u5.toString()}
      Received: ${Object.keys(n3).toString()}`)), O3(i5, d4) || (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces chains don't satisfy required namespaces.
      Required: ${i5.toString()}
      Approved: ${d4.toString()}`)), Object.keys(n3).forEach((a5) => {
    if (!a5.includes(":") || r3)
      return;
    const b5 = A4(n3[a5].accounts);
    b5.includes(a5) || (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces accounts don't satisfy namespace accounts for ${a5}
        Required: ${a5}
        Approved: ${b5.toString()}`));
  }), i5.forEach((a5) => {
    r3 || (O3(o3[a5].methods, s3[a5].methods) ? O3(o3[a5].events, s3[a5].events) || (r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces events don't satisfy namespace events for ${a5}`)) : r3 = N10("NON_CONFORMING_NAMESPACES", `${t3} namespaces methods don't satisfy namespace methods for ${a5}`));
  }), r3;
}
function er(e3) {
  const n3 = {};
...
function hn(e3) {
  !$3() && D4() && (window.addEventListener("online", () => e3(true)), window.addEventListener("offline", () => e3(false)));
}
function vn(e3) {
  $3() && typeof global < "u" && global != null && global.NetInfo && (global == null ? void 0 : global.NetInfo.addEventListener((n3) => e3(n3 == null ? void 0 : n3.isConnected)));
}
var ae = {};
var sr = class {
  static get(n3) {
...
var a4 = (c6) => c6.split("?")[0];
var h5 = 10;
var S2 = w5();
var f3 = class {
  constructor(e3) {
    if (this.url = e3, this.events = new import_events4.EventEmitter(), this.registering = false, !isWsUrl(e3))
  ...
  async send(e3) {
    ...
    try {
      this.socket.send(safeJsonStringify6(e3));
    } catch (t3) {
  ...
  register(e3 = this.url) {
    ...
    if (this.registering) {
      ...
      return (this.events.listenerCount("register_error") >= t3 || this.events.listenerCount("open") >= t3) && this.events.setMaxListeners(t3 + 1), new Promise((n3, o3) => {
    ...
    return this.url = e3, this.registering = true, new Promise((t3, n3) => {
      const o3 = new URLSearchParams(e3).get("origin"), s3 = (0, esm_exports4.isReactNative)() ? { headers: { origin: o3 } } : { rejectUnauthorized: !isLocalhostUrl(e3) }, i5 = new S2(e3, [], s3);
      b2() ? i5.onerror = (r3) => {
        const l4 = r3;
  ...
  onPayload(e3) {
    if (typeof e3.data > "u")
      return;
    const t3 = typeof e3.data == "string" ? safeJsonParse6(e3.data) : e3.data;
    this.events.emit("payload", t3);
  }
  onError(e3, t3) {
    const n3 = this.parseError(t3), o3 = n3.message || n3.toString(), s3 = formatJsonRpcError(e3, o3);
  ...
  emitError(e3) {
    const t3 = this.parseError(new Error((e3 == null ? void 0 : e3.message) || `WebSocket connection failed for host: ${a4(this.url)}`));
...
function Hi(n3, e3) {
  if (n3.length >= 255)
    throw new TypeError("Alphabet too long");
  for (var t3 = new Uint8Array(256), i5 = 0; i5 < t3.length; i5++)
    t3[i5] = 255;
  for (var s3 = 0; s3 < n3.length; s3++) {
    var r3 = n3.charAt(s3), o3 = r3.charCodeAt(0);
    if (t3[o3] !== 255)
      throw new TypeError(r3 + " is ambiguous");
    t3[o3] = s3;
  }
  var a5 = n3.length, h6 = n3.charAt(0), l4 = Math.log(a5) / Math.log(256), d4 = Math.log(256) / Math.log(a5);
  function p5(u5) {
    ...
    if (u5.length === 0)
      return "";
    for (var m4 = 0, z5 = 0, I4 = 0, _6 = u5.length; I4 !== _6 && u5[I4] === 0; )
      I4++, m4++;
    for (var T4 = (_6 - I4) * d4 + 1 >>> 0, f4 = new Uint8Array(T4); I4 !== _6; ) {
      for (var S3 = u5[I4], A5 = 0, C3 = T4 - 1; (S3 !== 0 || A5 < z5) && C3 !== -1; C3--, A5++)
        S3 += 256 * f4[C3] >>> 0, f4[C3] = S3 % a5 >>> 0, S3 = S3 / a5 >>> 0;
      if (S3 !== 0)
        throw new Error("Non-zero carry");
      z5 = A5, I4++;
    }
    for (var x5 = T4 - z5; x5 !== T4 && f4[x5] === 0; )
      x5++;
    for (var j5 = h6.repeat(m4); x5 < T4; ++x5)
      j5 += n3.charAt(f4[x5]);
    return j5;
  }
  function y6(u5) {
    ...
    if (u5[m4] !== " ") {
      ...
      if (u5[m4] !== " ") {
        for (var C3 = _6 - I4; C3 !== _6 && T4[C3] === 0; )
          C3++;
        for (var x5 = new Uint8Array(z5 + (_6 - C3)), j5 = z5; C3 !== _6; )
          x5[j5++] = T4[C3++];
        return x5;
      }
    }
...
var Zi = class {
  constructor(e3, t3, i5) {
    this.name = e3, this.prefix = t3, this.baseEncode = i5;
  }
  encode(e3) {
...
var es = class {
  constructor(e3, t3, i5) {
    if (this.name = e3, this.prefix = t3, t3.codePointAt(0) === void 0)
      throw new Error("Invalid prefix character");
    this.prefixCodePoint = t3.codePointAt(0), this.baseDecode = i5;
  }
  decode(e3) {
    if (typeof e3 == "string") {
...
var ts = class {
  ...
  decode(e3) {
    const t3 = e3[0], i5 = this.decoders[t3];
    if (i5)
      return i5.decode(e3);
...
var is = class {
  constructor(e3, t3, i5, s3) {
    this.name = e3, this.prefix = t3, this.baseEncode = i5, this.baseDecode = s3, this.encoder = new Zi(e3, t3, i5), this.decoder = new es(e3, t3, s3);
  }
  encode(e3) {
...
var W3 = ({ name: n3, prefix: e3, encode: t3, decode: i5 }) => new is(n3, e3, t3, i5);
var B3 = ({ prefix: n3, name: e3, alphabet: t3 }) => {
  const { encode: i5, decode: s3 } = Xi(t3, e3);
  return W3({ prefix: n3, name: e3, encode: i5, decode: (r3) => Ne(s3(r3)) });
};
var ss = (n3, e3, t3, i5) => {
  const s3 = {};
  ...
  for (let d4 = 0; d4 < r3; ++d4) {
    const p5 = s3[n3[d4]];
    if (p5 === void 0)
      throw new SyntaxError(`Non-${i5} character`);
    h6 = h6 << t3 | p5, a5 += t3, a5 >= 8 && (a5 -= 8, o3[l4++] = 255 & h6 >> a5);
  }
  if (a5 >= t3 || 255 & h6 << 8 - a5)
    throw new SyntaxError("Unexpected end of data");
  return o3;
};
var rs = (n3, e3, t3) => {
  const i5 = e3[e3.length - 1] === "=", s3 = (1 << t3) - 1;
  let r3 = "", o3 = 0, a5 = 0;
  for (let h6 = 0; h6 < n3.length; ++h6)
    for (a5 = a5 << 8 | n3[h6], o3 += 8; o3 > t3; )
      o3 -= t3, r3 += e3[s3 & a5 >> o3];
  if (o3 && (r3 += e3[s3 & a5 << t3 - o3]), i5)
    for (; r3.length * t3 & 7; )
      r3 += "=";
  return r3;
};
var g5 = ({ name: n3, prefix: e3, bitsPerChar: t3, alphabet: i5 }) => W3({ prefix: e3, name: n3, encode(s3) {
  return rs(s3, i5, t3);
}, decode(s3) {
  return ss(s3, i5, t3, n3);
} });
...
var xs = B3({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var Os = Object.freeze({ __proto__: null, base58btc: Ps, base58flickr: xs });
var As = g5({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var zs = g5({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var Ns = g5({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var Us = g5({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
...
function Fe(n3, e3, t3) {
  e3 = e3 || [], t3 = t3 || 0;
  for (var i5 = t3; n3 >= Gs; )
    e3[t3++] = n3 & 255 | $e2, n3 /= 128;
  for (; n3 & js; )
    e3[t3++] = n3 & 255 | $e2, n3 >>>= 7;
  return e3[t3] = n3 | 0, Fe.bytes = t3 - i5 + 1, e3;
}
var Ys = he2;
var Hs = 128;
var Me2 = 127;
function he2(n3, i5) {
  var t3 = 0, i5 = i5 || 0, s3 = 0, r3 = i5, o3, a5 = n3.length;
  do {
    if (r3 >= a5)
      throw he2.bytes = 0, new RangeError("Could not decode varint");
    o3 = n3[r3++], t3 += s3 < 28 ? (o3 & Me2) << s3 : (o3 & Me2) * Math.pow(2, s3), s3 += 7;
  } while (o3 >= Hs);
  return he2.bytes = r3 - i5, t3;
}
var Js = Math.pow(2, 7);
...
var rr2 = function(n3) {
  return n3 < Js ? 1 : n3 < Xs ? 2 : n3 < Ws ? 3 : n3 < Qs ? 4 : n3 < Zs ? 5 : n3 < er2 ? 6 : n3 < tr2 ? 7 : n3 < ir ? 8 : n3 < sr2 ? 9 : 10;
};
...
var ce2 = (n3, e3) => {
  const t3 = e3.byteLength, i5 = Be2(n3), s3 = i5 + Be2(t3), r3 = new Uint8Array(s3 + t3);
  return Ke2(n3, r3, 0), Ke2(t3, r3, i5), r3.set(e3, s3), new or3(n3, t3, e3, r3);
};
var or3 = class {
  constructor(e3, t3, i5, s3) {
    this.code = e3, this.size = t3, this.digest = i5, this.bytes = s3;
  }
};
var Ve2 = ({ name: n3, code: e3, encode: t3 }) => new ar(n3, e3, t3);
var ar = class {
  constructor(e3, t3, i5) {
    this.name = e3, this.code = t3, this.encode = i5;
  }
  digest(e3) {
    if (e3 instanceof Uint8Array) {
      const t3 = this.encode(e3);
      return t3 instanceof Uint8Array ? ce2(this.code, t3) : t3.then((i5) => ce2(this.code, i5));
    } else
      throw Error("Unknown type, must be binary type");
  }
};
...
function Dr(n3 = 0) {
  return globalThis.Buffer != null && globalThis.Buffer.allocUnsafe != null ? He2(globalThis.Buffer.allocUnsafe(n3)) : new Uint8Array(n3);
}
function Je(n3, e3, t3, i5) {
  return { name: n3, prefix: e3, encoder: { name: n3, prefix: e3, encode: t3 }, decoder: { decode: i5 } };
}
var Xe2 = Je("utf8", "u", (n3) => "u" + new TextDecoder("utf8").decode(n3), (n3) => new TextEncoder().encode(n3.substring(1)));
var ue2 = Je("ascii", "a", (n3) => {
  let e3 = "a";
  for (let t3 = 0; t3 < n3.length; t3++)
    e3 += String.fromCharCode(n3[t3]);
  return e3;
}, (n3) => {
  n3 = n3.substring(1);
  const e3 = Dr(n3.length);
  for (let t3 = 0; t3 < n3.length; t3++)
    e3[t3] = n3.charCodeAt(t3);
  return e3;
});
...
function mr(n3, e3 = "utf8") {
  ...
  return (e3 === "utf8" || e3 === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? He2(globalThis.Buffer.from(n3, "utf-8")) : t3.decoder.decode(`${t3.prefix}${n3}`);
}
var le2 = "wc";
var We2 = 2;
var Q3 = "core";
...
var ut2 = "relayer";
var D5 = { message: "relayer_message", message_ack: "relayer_message_ack", connect: "relayer_connect", disconnect: "relayer_disconnect", error: "relayer_error", connection_stalled: "relayer_connection_stalled", transport_closed: "relayer_transport_closed", publish: "relayer_publish" };
...
var w6 = { created: "subscription_created", deleted: "subscription_deleted", expired: "subscription_expired", disabled: "subscription_disabled", sync: "subscription_sync", resubscribed: "subscription_resubscribed" };
var mt2 = "subscription";
var bt2 = "0.3";
var ft2 = import_time3.FIVE_SECONDS * 1e3;
var Et2 = "pairing";
var wt2 = "0.3";
var $4 = { wc_pairingDelete: { req: { ttl: import_time3.ONE_DAY, prompt: false, tag: 1e3 }, res: { ttl: import_time3.ONE_DAY, prompt: false, tag: 1001 } }, wc_pairingPing: { req: { ttl: import_time3.THIRTY_SECONDS, prompt: false, tag: 1002 }, res: { ttl: import_time3.THIRTY_SECONDS, prompt: false, tag: 1003 } }, unregistered_method: { req: { ttl: import_time3.ONE_DAY, prompt: false, tag: 0 }, res: { ttl: import_time3.ONE_DAY, prompt: false, tag: 0 } } };
...
var Pt2 = class {
  constructor(e3, t3) {
    this.core = e3, this.logger = t3, this.keychain = /* @__PURE__ */ new Map(), this.name = it, this.version = st, this.initialized = false, this.storagePrefix = O4, this.init = async () => {
      if (!this.initialized) {
        const i5 = await this.getKeyChain();
        typeof i5 < "u" && (this.keychain = i5), this.initialized = true;
      }
    }, this.has = (i5) => (this.isInitialized(), this.keychain.has(i5)), this.set = async (i5, s3) => {
      this.isInitialized(), this.keychain.set(i5, s3), await this.persist();
    }, this.get = (i5) => {
      this.isInitialized();
      const s3 = this.keychain.get(i5);
      if (typeof s3 > "u") {
        const { message: r3 } = N10("NO_MATCHING_KEY", `${this.name}: ${i5}`);
        throw new Error(r3);
      }
      return s3;
    }, this.del = async (i5) => {
...
var xt2 = class {
  constructor(e3, t3, i5) {
    this.core = e3, this.logger = t3, this.name = et, this.initialized = false, this.init = async () => {
      this.initialized || (await this.keychain.init(), this.initialized = true);
    }, this.hasKeys = (s3) => (this.isInitialized(), this.keychain.has(s3)), this.getClientId = async () => {
      this.isInitialized();
      const s3 = await this.getClientSeed(), r3 = generateKeyPair(s3);
      ...
      this.isInitialized();
      const r3 = await this.getClientSeed(), o3 = generateKeyPair(r3), a5 = Vn(), h6 = tt;
      return await signJWT(a5, s3, h6, o3);
    }, this.generateSharedKey = (s3, r3, o3) => {
      this.isInitialized();
      const a5 = this.getPrivateKey(s3), h6 = Mn(a5, r3);
      ...
      this.isInitialized();
      const a5 = Ae(o3), h6 = safeJsonStringify4(r3);
      if (qn(a5)) {
        const y6 = a5.senderPublicKey, M5 = a5.receiverPublicKey;
        s3 = await this.generateSharedKey(y6, M5);
      }
      const l4 = this.getSymKey(s3), { type: d4, senderPublicKey: p5 } = a5;
      return xn({ type: d4, symKey: l4, message: h6, senderPublicKey: p5 });
    }, this.decode = async (s3, r3, o3) => {
      this.isInitialized();
      const a5 = Hn(r3, o3);
      if (qn(a5)) {
        const h6 = a5.receiverPublicKey, l4 = a5.senderPublicKey;
        s3 = await this.generateSharedKey(h6, l4);
      }
      try {
        const h6 = this.getSymKey(s3), l4 = Fn({ symKey: h6, encoded: r3 });
        return safeJsonParse4(l4);
      } catch (h6) {
    ...
    }, this.core = e3, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.keychain = i5 || new Pt2(this.core, this.logger);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var Ot2 = class extends a3 {
  constructor(e3, t3) {
    super(e3, t3), this.logger = e3, this.core = t3, this.messages = /* @__PURE__ */ new Map(), this.name = rt2, this.version = nt, this.initialized = false, this.storagePrefix = O4, this.init = async () => {
      if (!this.initialized) {
        this.logger.trace("Initialized");
        try {
          const i5 = await this.getRelayerMessages();
          typeof i5 < "u" && (this.messages = i5), this.logger.debug(`Successfully Restored records for ${this.name}`), this.logger.trace({ type: "method", method: "restore", size: this.messages.size });
        } catch (i5) {
    ...
    }, this.set = async (i5, s3) => {
      this.isInitialized();
      const r3 = Ln(s3);
      let o3 = this.messages.get(i5);
      return typeof o3 > "u" && (o3 = {}), typeof o3[r3] < "u" || (o3[r3] = s3, this.messages.set(i5, o3), await this.persist()), r3;
    }, this.get = (i5) => {
      this.isInitialized();
      ...
      this.isInitialized();
      const r3 = this.get(i5), o3 = Ln(s3);
      return typeof r3[o3] < "u";
    }, this.del = async (i5) => {
      this.isInitialized(), this.messages.delete(i5), await this.persist();
...
var vr = class extends u3 {
  constructor(e3, t3) {
    super(e3, t3), this.relayer = e3, this.logger = t3, this.events = new import_events5.EventEmitter(), this.name = at2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS * 2), this.needsTransportRestart = false, this.publish = async (i5, s3, r3) => {
      var o3;
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i5, message: s3, opts: r3 } });
      try {
        const a5 = (r3 == null ? void 0 : r3.ttl) || ot2, h6 = vt(r3), l4 = (r3 == null ? void 0 : r3.prompt) || false, d4 = (r3 == null ? void 0 : r3.tag) || 0, p5 = (r3 == null ? void 0 : r3.id) || getBigIntRpcId().toString(), y6 = { topic: i5, message: s3, opts: { ttl: a5, relay: h6, prompt: l4, tag: d4, id: p5 } }, M5 = setTimeout(() => this.queue.set(p5, y6), this.publishTimeout);
        try {
          await await ut(this.rpcPublish(i5, s3, a5, h6, l4, d4, p5), this.publishTimeout, `Failed to publish payload, please try again. id:${p5} tag:${d4}`), this.removeRequestFromQueue(p5), this.relayer.events.emit(D5.publish, y6);
        } catch (u5) {
          if (this.logger.debug("Publishing Payload stalled"), this.needsTransportRestart = true, (o3 = r3 == null ? void 0 : r3.internal) != null && o3.throwOnFailedPublish)
            throw this.removeRequestFromQueue(p5), u5;
          return;
        } finally {
          clearTimeout(M5);
        }
        this.logger.debug("Successfully Published Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i5, message: s3, opts: r3 } });
      } catch (a5) {
  ...
  rpcPublish(e3, t3, i5, s3, r3, o3, a5) {
    var h6, l4, d4, p5;
    const y6 = { method: Et(s3.protocol).publish, params: { topic: e3, message: t3, ttl: i5, prompt: r3, tag: o3 }, id: a5 };
    return w4((h6 = y6.params) == null ? void 0 : h6.prompt) && ((l4 = y6.params) == null || delete l4.prompt), w4((d4 = y6.params) == null ? void 0 : d4.tag) && ((p5 = y6.params) == null || delete p5.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y6 }), this.relayer.request(y6);
  }
  ...
  checkQueue() {
    this.queue.forEach(async (e3) => {
      const { topic: t3, message: i5, opts: s3 } = e3;
      await this.publish(t3, i5, s3);
    });
  }
  registerEventListeners() {
...
var Ir = class {
  constructor() {
    this.map = /* @__PURE__ */ new Map(), this.set = (e3, t3) => {
      const i5 = this.get(e3);
      this.exists(e3, t3) || this.map.set(e3, [...i5, t3]);
...
var zt2 = (n3, e3, t3) => e3 in n3 ? Cr(n3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : n3[e3] = t3;
var q3 = (n3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    Tr.call(e3, t3) && zt2(n3, t3, e3[t3]);
  if (At)
    for (var t3 of At(e3))
      Sr.call(e3, t3) && zt2(n3, t3, e3[t3]);
  return n3;
};
...
var Nt2 = class extends d3 {
  constructor(e3, t3) {
    ...
    }, this.subscribe = async (i5, s3) => {
      await this.restartToComplete(), this.isInitialized(), this.logger.debug("Subscribing Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: i5, opts: s3 } });
      try {
        const r3 = vt(s3), o3 = { topic: i5, relay: r3 };
        this.pending.set(i5, o3);
        const a5 = await this.rpcSubscribe(i5, r3);
        return this.onSubscribe(a5, o3), this.logger.debug("Successfully Subscribed Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: i5, opts: s3 } }), a5;
      } catch (r3) {
        throw this.logger.debug("Failed to Subscribe Topic"), this.logger.error(r3), r3;
      }
    }, this.unsubscribe = async (i5, s3) => {
      await this.restartToComplete(), this.isInitialized(), typeof (s3 == null ? void 0 : s3.id) < "u" ? await this.unsubscribeById(i5, s3.id, s3) : await this.unsubscribeByTopic(i5, s3);
    }, this.isSubscribed = async (i5) => {
      if (this.topics.includes(i5))
        return true;
      const s3 = `${this.pendingSubscriptionWatchLabel}_${i5}`;
      return await new Promise((r3, o3) => {
        const a5 = new import_time3.Watch();
        a5.start(s3);
        const h6 = setInterval(() => {
          !this.pending.has(i5) && this.topics.includes(i5) && (clearInterval(h6), a5.stop(s3), r3(true)), a5.elapsed(s3) >= ft2 && (clearInterval(h6), a5.stop(s3), o3(new Error("Subscription resolution timeout")));
  ...
  hasSubscription(e3, t3) {
    let i5 = false;
    try {
      i5 = this.getSubscription(e3).topic === t3;
    } catch {
    }
    return i5;
  }
  ...
  async unsubscribeByTopic(e3, t3) {
    const i5 = this.topicMap.get(e3);
    await Promise.all(i5.map(async (s3) => await this.unsubscribeById(e3, s3, t3)));
  }
  async unsubscribeById(e3, t3, i5) {
    this.logger.debug("Unsubscribing Topic"), this.logger.trace({ type: "method", method: "unsubscribe", params: { topic: e3, id: t3, opts: i5 } });
    try {
      const s3 = vt(i5);
      await this.rpcUnsubscribe(e3, t3, s3);
      const r3 = U2("USER_DISCONNECTED", `${this.name}, ${e3}`);
      await this.onUnsubscribe(e3, t3, r3), this.logger.debug("Successfully Unsubscribed Topic"), this.logger.trace({ type: "method", method: "unsubscribe", params: { topic: e3, id: t3, opts: i5 } });
    } catch (s3) {
      throw this.logger.debug("Failed to Unsubscribe Topic"), this.logger.error(s3), s3;
    }
  }
  async rpcSubscribe(e3, t3) {
    const i5 = { method: Et(t3.protocol).subscribe, params: { topic: e3 } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i5 });
    try {
      await await ut(this.relayer.request(i5), this.subscribeTimeout);
    } catch {
      this.logger.debug("Outgoing Relay Subscribe Payload stalled"), this.relayer.events.emit(D5.connection_stalled);
    }
  ...
  async rpcBatchSubscribe(e3) {
    if (!e3.length)
      return;
    const t3 = e3[0].relay, i5 = { method: Et(t3.protocol).batchSubscribe, params: { topics: e3.map((s3) => s3.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i5 });
    try {
      return await await ut(this.relayer.request(i5), this.subscribeTimeout);
    } catch {
      this.logger.debug("Outgoing Relay Payload stalled"), this.relayer.events.emit(D5.connection_stalled);
    }
  }
  rpcUnsubscribe(e3, t3, i5) {
    const s3 = { method: Et(i5.protocol).unsubscribe, params: { topic: e3, id: t3 } };
  ...
  async onUnsubscribe(e3, t3, i5) {
    this.events.removeAllListeners(t3), this.hasSubscription(t3, e3) && this.deleteSubscription(t3, i5), await this.relayer.messages.del(e3);
  }
  ...
  addSubscription(e3, t3) {
    this.subscriptions.set(e3, q3({}, t3)), this.topicMap.set(t3.topic, e3), this.events.emit(w6.created, t3);
  }
  getSubscription(e3) {
    ...
    if (!t3) {
      const { message: i5 } = N10("NO_MATCHING_KEY", `${this.name}: ${e3}`);
      throw new Error(i5);
    }
    return t3;
  }
  deleteSubscription(e3, t3) {
    ...
    const i5 = this.getSubscription(e3);
    this.subscriptions.delete(e3), this.topicMap.delete(i5.topic, e3), this.events.emit(w6.deleted, De2(q3({}, i5), { reason: t3 }));
  }
  async persist() {
    await this.setRelayerSubscriptions(this.values), this.events.emit(w6.sync);
  }
  async reset() {
    if (this.cached.length) {
      const e3 = Math.ceil(this.cached.length / this.batchSubscribeTopicsLimit);
      for (let t3 = 0; t3 < e3; t3++) {
        const i5 = this.cached.splice(0, this.batchSubscribeTopicsLimit);
        await this.batchSubscribe(i5);
      }
    }
    this.events.emit(w6.resubscribed);
  }
  async restore() {
    try {
  ...
  async batchSubscribe(e3) {
    ...
    k4(t3) && this.onBatchSubscribe(t3.map((i5, s3) => De2(q3({}, e3[s3]), { id: i5 })));
  }
  async onConnect() {
...
var Lt2 = (n3, e3, t3) => e3 in n3 ? Pr(n3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : n3[e3] = t3;
var Ar = (n3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    xr.call(e3, t3) && Lt2(n3, t3, e3[t3]);
  if (Ut)
    for (var t3 of Ut(e3))
      Or.call(e3, t3) && Lt2(n3, t3, e3[t3]);
  return n3;
};
var $t = class extends g3 {
  constructor(e3) {
    super(e3), this.protocol = "wc", this.version = 2, this.events = new import_events5.EventEmitter(), this.name = ut2, this.transportExplicitlyClosed = false, this.initialized = false, this.connectionAttemptInProgress = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.hasExperiencedNetworkDisruption = false, this.requestsInFlight = /* @__PURE__ */ new Map(), this.request = async (t3) => {
      this.logger.debug("Publishing Request Payload");
      const i5 = t3.id;
      try {
        await this.toEstablishConnection();
        const s3 = this.provider.request(t3);
        return this.requestsInFlight.set(i5, { promise: s3, request: t3 }), await s3;
      } catch (s3) {
        throw this.logger.debug("Failed to Publish Request"), this.logger.error(s3), s3;
      } finally {
        this.requestsInFlight.delete(i5);
      }
      ...
      this.logger.error(t3), this.events.emit(D5.error, t3), this.logger.info("Fatal socket error received, closing transport"), this.transportClose();
    }, this.registerProviderListeners = () => {
      this.provider.on(P3.payload, this.onPayloadHandler), this.provider.on(P3.connect, this.onConnectHandler), this.provider.on(P3.disconnect, this.onDisconnectHandler), this.provider.on(P3.error, this.onProviderErrorHandler);
    }, this.core = e3.core, this.logger = typeof e3.logger < "u" && typeof e3.logger != "string" ? (0, import_logger.generateChildLogger)(e3.logger, this.name) : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: e3.logger || ct })), this.messages = new Ot2(this.logger, e3.core), this.subscriber = new Nt2(this, this.logger), this.publisher = new vr(this, this.logger), this.relayUrl = (e3 == null ? void 0 : e3.relayUrl) || ge2, this.projectId = e3.projectId, this.bundleId = Jn(), this.provider = {};
  }
  async init() {
  ...
  async publish(e3, t3, i5) {
    this.isInitialized(), await this.publisher.publish(e3, t3, i5), await this.recordMessageEvent({ topic: e3, message: t3, publishedAt: Date.now() });
  }
  async subscribe(e3, t3) {
    var i5;
    this.isInitialized();
    let s3 = ((i5 = this.subscriber.topicMap.get(e3)) == null ? void 0 : i5[0]) || "";
    if (s3)
      return s3;
    let r3;
    const o3 = (a5) => {
      a5.topic === e3 && (this.subscriber.off(w6.created, o3), r3());
    };
    return await Promise.all([new Promise((a5) => {
      r3 = a5, this.subscriber.on(w6.created, o3);
  ...
  async transportClose() {
    this.requestsInFlight.size > 0 && (this.logger.debug("Waiting for all in-flight requests to finish before closing transport..."), this.requestsInFlight.forEach(async (e3) => {
      await e3.promise;
    ...
    if (this.transportExplicitlyClosed = false, await this.confirmOnlineStateOrThrow(), !this.connectionAttemptInProgress) {
      ...
      try {
        await Promise.all([new Promise((t3) => {
          if (!this.initialized)
            return t3();
          this.subscriber.once(w6.resubscribed, () => {
            t3();
          });
        }), new Promise(async (t3, i5) => {
          try {
        ...
        const i5 = t3;
        if (!this.isConnectionStalled(i5.message))
          throw t3;
  ...
  async createProvider() {
    ...
    this.provider = new JsonRpcProvider(new f3(Xn({ sdkVersion: gt2, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e3, useOnCloseEvent: true, bundleId: this.bundleId }))), this.registerProviderListeners();
  }
  async recordMessageEvent(e3) {
    const { topic: t3, message: i5 } = e3;
    await this.messages.set(t3, i5);
  }
  async shouldIgnoreMessageEvent(e3) {
    const { topic: t3, message: i5 } = e3;
    if (!i5 || i5.length === 0)
      return this.logger.debug(`Ignoring invalid/empty message: ${i5}`), true;
    if (!await this.subscriber.isSubscribed(t3))
      return this.logger.debug(`Ignoring message for non-subscribed topic ${t3}`), true;
    const s3 = this.messages.has(t3, i5);
    return s3 && this.logger.debug(`Ignoring duplicate message: ${i5}`), s3;
  }
  async onProviderPayload(e3) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e3 }), isJsonRpcRequest(e3)) {
      if (!e3.method.endsWith(lt2))
        return;
      const t3 = e3.params, { topic: i5, message: s3, publishedAt: r3 } = t3.data, o3 = { topic: i5, message: s3, publishedAt: r3 };
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(Ar({ type: "event", event: t3.id }, o3)), this.events.emit(t3.id, o3), await this.acknowledgePayload(e3), await this.onMessageEvent(o3);
    } else
      isJsonRpcResponse(e3) && this.events.emit(D5.message_ack, e3);
  }
  async onMessageEvent(e3) {
    await this.shouldIgnoreMessageEvent(e3) || (this.events.emit(D5.message, e3), await this.recordMessageEvent(e3));
  }
  ...
  unregisterProviderListeners() {
    this.provider.off(P3.payload, this.onPayloadHandler), this.provider.off(P3.connect, this.onConnectHandler), this.provider.off(P3.disconnect, this.onDisconnectHandler), this.provider.off(P3.error, this.onProviderErrorHandler);
  }
  async registerEventListeners() {
    ...
    let e3 = await rr();
    or2(async (t3) => {
      this.initialized && e3 !== t3 && (e3 = t3, t3 ? await this.restartTransport().catch((i5) => this.logger.error(i5)) : (this.hasExperiencedNetworkDisruption = true, await this.transportClose().catch((i5) => this.logger.error(i5))));
    });
  }
...
var Mt2 = (n3, e3, t3) => e3 in n3 ? zr(n3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : n3[e3] = t3;
var kt = (n3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    Nr.call(e3, t3) && Mt2(n3, t3, e3[t3]);
  if (Ft2)
    for (var t3 of Ft2(e3))
      Ur.call(e3, t3) && Mt2(n3, t3, e3[t3]);
  return n3;
};
var Kt2 = class extends p3 {
  constructor(e3, t3, i5, s3 = O4, r3 = void 0) {
    super(e3, t3, i5, s3), this.core = e3, this.logger = t3, this.name = i5, this.map = /* @__PURE__ */ new Map(), this.version = Dt, this.cached = [], this.initialized = false, this.storagePrefix = O4, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((o3) => {
        this.getKey && o3 !== null && !w4(o3) ? this.map.set(this.getKey(o3), o3) : Lt(o3) ? this.map.set(o3.id, o3) : xt(o3) && this.map.set(o3.topic, o3);
      }), this.cached = [], this.initialized = true);
    }, this.set = async (o3, a5) => {
      this.isInitialized(), this.map.has(o3) ? await this.update(o3, a5) : (this.logger.debug("Setting value"), this.logger.trace({ type: "method", method: "set", key: o3, value: a5 }), this.map.set(o3, a5), await this.persist());
    }, this.get = (o3) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: o3 }), this.getData(o3)), this.getAll = (o3) => (this.isInitialized(), o3 ? this.values.filter((a5) => Object.keys(o3).every((h6) => (0, import_lodash.default)(a5[h6], o3[h6]))) : this.values), this.update = async (o3, a5) => {
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: o3, update: a5 });
      const h6 = kt(kt({}, this.getData(o3)), a5);
      this.map.set(o3, h6), await this.persist();
    }, this.delete = async (o3, a5) => {
      this.isInitialized(), this.map.has(o3) && (this.logger.debug("Deleting value"), this.logger.trace({ type: "method", method: "delete", key: o3, reason: a5 }), this.map.delete(o3), await this.persist());
    }, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.storagePrefix = s3, this.getKey = r3;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var Bt2 = class {
  constructor(e3, t3) {
    this.core = e3, this.logger = t3, this.name = Et2, this.version = wt2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = O4, this.ignoredPayloadTypes = [_5], this.registeredMethods = [], this.init = async () => {
      this.initialized || (await this.pairings.init(), await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.initialized = true, this.logger.trace("Initialized"));
    }, this.register = ({ methods: i5 }) => {
      this.isInitialized(), this.registeredMethods = [.../* @__PURE__ */ new Set([...this.registeredMethods, ...i5])];
    }, this.create = async () => {
      this.isInitialized();
      const i5 = Vn(), s3 = await this.core.crypto.setSymKey(i5), r3 = pt(import_time3.FIVE_MINUTES), o3 = { protocol: ht2 }, a5 = { topic: s3, expiry: r3, relay: o3, active: false }, h6 = Rt({ protocol: this.core.protocol, version: this.core.version, topic: s3, symKey: i5, relay: o3, expiryTimestamp: r3 });
      return await this.pairings.set(s3, a5), await this.core.relayer.subscribe(s3), this.core.expirer.set(s3, r3), { topic: s3, uri: h6 };
    }, this.pair = async (i5) => {
      this.isInitialized(), this.isValidPair(i5);
      const { topic: s3, symKey: r3, relay: o3, expiryTimestamp: a5 } = Pt(i5.uri);
      let h6;
      ...
      const l4 = a5 || pt(import_time3.FIVE_MINUTES), d4 = { topic: s3, relay: o3, expiry: l4, active: false };
      return await this.pairings.set(s3, d4), this.core.expirer.set(s3, l4), i5.activatePairing && await this.activate({ topic: s3 }), this.events.emit(V3.create, d4), this.core.crypto.keychain.has(s3) || (await this.core.crypto.setSymKey(r3, s3), await this.core.relayer.subscribe(s3, { relay: o3 })), d4;
    }, this.activate = async ({ topic: i5 }) => {
      this.isInitialized();
      const s3 = pt(import_time3.THIRTY_DAYS);
      await this.pairings.update(i5, { active: true, expiry: s3 }), this.core.expirer.set(i5, s3);
    }, this.ping = async (i5) => {
      this.isInitialized(), await this.isValidPing(i5);
      const { topic: s3 } = i5;
      if (this.pairings.keys.includes(s3)) {
        const r3 = await this.sendRequest(s3, "wc_pairingPing", {}), { done: o3, resolve: a5, reject: h6 } = at();
        this.events.once(yt("pairing_ping", r3), ({ error: l4 }) => {
          l4 ? h6(l4) : a5();
        }), await o3();
      }
    }, this.updateExpiry = async ({ topic: i5, expiry: s3 }) => {
      this.isInitialized(), await this.pairings.update(i5, { expiry: s3 });
    }, this.updateMetadata = async ({ topic: i5, metadata: s3 }) => {
      this.isInitialized(), await this.pairings.update(i5, { peerMetadata: s3 });
    }, this.getPairings = () => (this.isInitialized(), this.pairings.values), this.disconnect = async (i5) => {
    ...
    }, this.sendRequest = async (i5, s3, r3) => {
      const o3 = formatJsonRpcRequest(s3, r3), a5 = await this.core.crypto.encode(i5, o3), h6 = $4[s3].req;
      return this.core.history.set(i5, o3), this.core.relayer.publish(i5, a5, h6), o3.id;
    }, this.sendResult = async (i5, s3, r3) => {
      const o3 = formatJsonRpcResult(i5, r3), a5 = await this.core.crypto.encode(s3, o3), h6 = await this.core.history.get(s3, i5), l4 = $4[h6.request.method].res;
      await this.core.relayer.publish(s3, a5, l4), await this.core.history.resolve(o3);
    }, this.sendError = async (i5, s3, r3) => {
      const o3 = formatJsonRpcError(i5, r3), a5 = await this.core.crypto.encode(s3, o3), h6 = await this.core.history.get(s3, i5), l4 = $4[h6.request.method] ? $4[h6.request.method].res : $4.unregistered_method.res;
      await this.core.relayer.publish(s3, a5, l4), await this.core.history.resolve(o3);
    }, this.deletePairing = async (i5, s3) => {
      await this.core.relayer.unsubscribe(i5), await Promise.all([this.pairings.delete(i5, U2("USER_DISCONNECTED")), this.core.crypto.deleteSymKey(i5), s3 ? Promise.resolve() : this.core.expirer.del(i5)]);
    }, this.cleanup = async () => {
      const i5 = this.pairings.getAll().filter((s3) => mt(s3.expiry));
      await Promise.all(i5.map((s3) => this.deletePairing(s3.topic)));
    }, this.onRelayEventRequest = (i5) => {
      const { topic: s3, payload: r3 } = i5;
      switch (r3.method) {
        case "wc_pairingPing":
    ...
    }, this.onRelayEventResponse = async (i5) => {
      const { topic: s3, payload: r3 } = i5, o3 = (await this.core.history.get(s3, r3.id)).request.method;
      switch (o3) {
        case "wc_pairingPing":
    ...
    }, this.onPairingPingRequest = async (i5, s3) => {
      const { id: r3 } = s3;
      try {
        this.isValidPing({ topic: i5 }), await this.sendResult(r3, i5, true), this.events.emit(V3.ping, { id: r3, topic: i5 });
      } catch (o3) {
        await this.sendError(r3, i5, o3), this.logger.error(o3);
      }
    }, this.onPairingPingResponse = (i5, s3) => {
      const { id: r3 } = s3;
      setTimeout(() => {
        isJsonRpcResult(s3) ? this.events.emit(yt("pairing_ping", r3), {}) : isJsonRpcError(s3) && this.events.emit(yt("pairing_ping", r3), { error: s3.error });
      }, 500);
    }, this.onPairingDeleteRequest = async (i5, s3) => {
      const { id: r3 } = s3;
      try {
        this.isValidDisconnect({ topic: i5 }), await this.deletePairing(i5), this.events.emit(V3.delete, { id: r3, topic: i5 });
      } catch (o3) {
        await this.sendError(r3, i5, o3), this.logger.error(o3);
      }
    }, this.onUnknownRpcMethodRequest = async (i5, s3) => {
      const { id: r3, method: o3 } = s3;
      try {
        if (this.registeredMethods.includes(o3))
          return;
        const a5 = U2("WC_METHOD_UNSUPPORTED", o3);
        await this.sendError(r3, i5, a5), this.logger.error(a5);
      } catch (a5) {
        await this.sendError(r3, i5, a5), this.logger.error(a5);
      }
    }, this.onUnknownRpcMethodResponse = (i5) => {
      this.registeredMethods.includes(i5) || this.logger.error(U2("WC_METHOD_UNSUPPORTED", i5));
    }, this.isValidPair = (i5) => {
      var s3;
      if (!Gt(i5)) {
        const { message: o3 } = N10("MISSING_OR_INVALID", `pair() params: ${i5}`);
        throw new Error(o3);
      }
      if (!Kt(i5.uri)) {
        const { message: o3 } = N10("MISSING_OR_INVALID", `pair() uri: ${i5.uri}`);
        throw new Error(o3);
      }
      const r3 = Pt(i5.uri);
      ...
      if (r3 != null && r3.expiryTimestamp && (0, import_time3.toMiliseconds)(r3 == null ? void 0 : r3.expiryTimestamp) < Date.now()) {
        const { message: o3 } = N10("EXPIRED", "pair() URI has expired. Please try again with a new connection URI.");
        throw new Error(o3);
      }
    }, this.isValidPing = async (i5) => {
      if (!Gt(i5)) {
        const { message: r3 } = N10("MISSING_OR_INVALID", `ping() params: ${i5}`);
        throw new Error(r3);
      }
      const { topic: s3 } = i5;
      await this.isValidPairingTopic(s3);
    }, this.isValidDisconnect = async (i5) => {
      if (!Gt(i5)) {
        const { message: r3 } = N10("MISSING_OR_INVALID", `disconnect() params: ${i5}`);
        throw new Error(r3);
      }
      const { topic: s3 } = i5;
      await this.isValidPairingTopic(s3);
    }, this.isValidPairingTopic = async (i5) => {
      if (!g4(i5, false)) {
        const { message: s3 } = N10("MISSING_OR_INVALID", `pairing topic should be a string: ${i5}`);
        throw new Error(s3);
      }
      if (!this.pairings.keys.includes(i5)) {
        const { message: s3 } = N10("NO_MATCHING_KEY", `pairing topic doesn't exist: ${i5}`);
        throw new Error(s3);
      }
      if (mt(this.pairings.get(i5).expiry)) {
        await this.deletePairing(i5);
        const { message: s3 } = N10("EXPIRED", `pairing topic: ${i5}`);
        throw new Error(s3);
      }
    }, this.core = e3, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.pairings = new Kt2(this.core, this.logger, this.name, this.storagePrefix);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
  ...
  registerRelayerEvents() {
    this.core.relayer.on(D5.message, async (e3) => {
      const { topic: t3, message: i5 } = e3;
      if (!this.pairings.keys.includes(t3) || this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i5)))
        return;
      const s3 = await this.core.crypto.decode(t3, i5);
      try {
...
var Vt = class extends h4 {
  constructor(e3, t3) {
    super(e3, t3), this.core = e3, this.logger = t3, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = vt2, this.version = It2, this.cached = [], this.initialized = false, this.storagePrefix = O4, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i5, request: s3, chainId: r3 }), this.records.has(s3.id))
        return;
      const o3 = { id: s3.id, topic: i5, request: { method: s3.method, params: s3.params || null }, chainId: r3, expiry: pt(import_time3.THIRTY_DAYS) };
      this.records.set(o3.id, o3), this.events.emit(R3.created, o3);
    }, this.resolve = async (i5) => {
      if (this.isInitialized(), this.logger.debug("Updating JSON-RPC response history record"), this.logger.trace({ type: "method", method: "update", response: i5 }), !this.records.has(i5.id))
        return;
      const s3 = await this.getRecord(i5.id);
      typeof s3.response > "u" && (s3.response = isJsonRpcError(i5) ? { error: i5.error } : { result: i5.result }, this.records.set(s3.id, s3), this.events.emit(R3.updated, s3));
    }, this.get = async (i5, s3) => (this.isInitialized(), this.logger.debug("Getting record"), this.logger.trace({ type: "method", method: "get", topic: i5, id: s3 }), await this.getRecord(s3)), this.delete = (i5, s3) => {
      this.isInitialized(), this.logger.debug("Deleting record"), this.logger.trace({ type: "method", method: "delete", id: s3 }), this.values.forEach((r3) => {
        if (r3.topic === i5) {
          if (typeof s3 < "u" && r3.id !== s3)
            return;
          this.records.delete(r3.id), this.events.emit(R3.deleted, r3);
        }
      });
    }, this.exists = async (i5, s3) => (this.isInitialized(), this.records.has(s3) ? (await this.getRecord(s3)).topic === i5 : false), this.on = (i5, s3) => {
      this.events.on(i5, s3);
    }, this.once = (i5, s3) => {
      this.events.once(i5, s3);
    }, this.off = (i5, s3) => {
  ...
  get pending() {
    ...
    return this.values.forEach((t3) => {
      if (typeof t3.response < "u")
        return;
      const i5 = { topic: t3.topic, request: formatJsonRpcRequest(t3.request.method, t3.request.params, t3.id), chainId: t3.chainId };
      return e3.push(i5);
    }), e3;
  }
...
var qt2 = class extends E5 {
  constructor(e3, t3) {
    super(e3, t3), this.core = e3, this.logger = t3, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = Ct, this.version = Rt2, this.cached = [], this.initialized = false, this.storagePrefix = O4, this.init = async () => {
      ...
      this.isInitialized();
      const r3 = this.formatTarget(i5), o3 = { target: r3, expiry: s3 };
      this.expirations.set(r3, o3), this.checkExpiry(r3, o3), this.events.emit(v4.created, { target: r3, expiration: o3 });
    }, this.get = (i5) => {
      this.isInitialized();
      const s3 = this.formatTarget(i5);
      ...
      if (this.isInitialized(), this.has(i5)) {
        const s3 = this.formatTarget(i5), r3 = this.getExpiration(s3);
  ...
  checkExpiry(e3, t3) {
    const { expiry: i5 } = t3;
    (0, import_time3.toMiliseconds)(i5) - Date.now() <= 0 && this.expire(e3, t3);
  }
  expire(e3, t3) {
  ...
  registerEventListeners() {
    this.core.heartbeat.on(import_heartbeat.HEARTBEAT_EVENTS.pulse, () => this.checkExpirations()), this.events.on(v4.created, (e3) => {
      const t3 = v4.created;
...
var jt = class extends y4 {
  constructor(e3, t3) {
    super(e3, t3), this.projectId = e3, this.logger = t3, this.name = Z3, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i5) => {
      if (this.verifyDisabled || $3() || !D4())
        return;
      const s3 = this.getVerifyUrl(i5 == null ? void 0 : i5.verifyUrl);
      ...
      this.initialized ? this.sendPost(i5.attestationId) : (this.addToQueue(i5.attestationId), await this.init());
    }, this.resolve = async (i5) => {
      if (this.isDevEnv)
        return "";
      const s3 = this.getVerifyUrl(i5 == null ? void 0 : i5.verifyUrl);
      let r3;
      try {
        r3 = await this.fetchAttestation(i5.attestationId, s3);
      } catch (o3) {
        this.logger.info(`failed to resolve attestation: ${i5.attestationId} from url: ${s3}`), this.logger.info(o3), r3 = await this.fetchAttestation(i5.attestationId, ee2);
      }
      return r3;
    }, this.fetchAttestation = async (i5, s3) => {
      this.logger.info(`resolving attestation: ${i5} from url: ${s3}`);
      const r3 = this.startAbortTimer(import_time3.ONE_SECOND * 2), o3 = await fetch(`${s3}/attestation/${i5}`, { signal: this.abortController.signal });
      return clearTimeout(r3), o3.status === 200 ? await o3.json() : void 0;
    }, this.addToQueue = (i5) => {
      this.queue.push(i5);
    }, this.processQueue = () => {
      this.queue.length !== 0 && (this.queue.forEach((i5) => this.sendPost(i5)), this.queue = []);
    }, this.sendPost = (i5) => {
      var s3;
      try {
        if (!this.iframe)
          return;
        (s3 = this.iframe.contentWindow) == null || s3.postMessage(i5, "*"), this.logger.info(`postMessage sent: ${i5} ${this.verifyUrl}`);
      } catch {
      }
    }, this.createIframe = async () => {
      let i5;
      const s3 = (r3) => {
        r3.data === "verify_ready" && (this.initialized = true, this.processQueue(), window.removeEventListener("message", s3), i5());
      };
      await Promise.race([new Promise((r3) => {
        ...
        o3.id = Z3, o3.src = `${this.verifyUrl}/${this.projectId}`, o3.style.display = "none", document.body.append(o3), this.iframe = o3, i5 = r3;
      ...
      let s3 = i5 || F4;
      return _t.includes(s3) || (this.logger.info(`verify url: ${s3}, not included in trusted list, assigning default: ${F4}`), s3 = F4), s3;
    }, this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.verifyUrl = F4, this.abortController = new AbortController(), this.isDevEnv = te() && process.env.IS_VITEST;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var Gt2 = class extends v3 {
  constructor(e3, t3) {
    super(e3, t3), this.projectId = e3, this.logger = t3, this.context = Tt2, this.registerDeviceToken = async (i5) => {
      const { clientId: s3, token: r3, notificationType: o3, enableEncrypted: a5 = false } = i5, h6 = `${St2}/${this.projectId}/clients`;
      await (0, import_isomorphic_unfetch.default)(h6, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ client_id: s3, type: o3, token: r3, always_raw: a5 }) });
...
var Ht2 = (n3, e3, t3) => e3 in n3 ? Lr(n3, e3, { enumerable: true, configurable: true, writable: true, value: t3 }) : n3[e3] = t3;
var Jt2 = (n3, e3) => {
  for (var t3 in e3 || (e3 = {}))
    $r.call(e3, t3) && Ht2(n3, t3, e3[t3]);
  if (Yt2)
    for (var t3 of Yt2(e3))
      Fr.call(e3, t3) && Ht2(n3, t3, e3[t3]);
  return n3;
};
var te2 = class _te extends n2 {
  constructor(e3) {
    super(e3), this.protocol = le2, this.version = We2, this.name = Q3, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i5, s3) => this.events.on(i5, s3), this.once = (i5, s3) => this.events.once(i5, s3), this.off = (i5, s3) => this.events.off(i5, s3), this.removeListener = (i5, s3) => this.events.removeListener(i5, s3), this.projectId = e3 == null ? void 0 : e3.projectId, this.relayUrl = (e3 == null ? void 0 : e3.relayUrl) || ge2, this.customStoragePrefix = e3 != null && e3.customStoragePrefix ? `:${e3.customStoragePrefix}` : "";
    const t3 = typeof (e3 == null ? void 0 : e3.logger) < "u" && typeof (e3 == null ? void 0 : e3.logger) != "string" ? e3.logger : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: (e3 == null ? void 0 : e3.logger) || Qe2.logger }));
    this.logger = (0, import_logger.generateChildLogger)(t3, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new xt2(this, this.logger, e3 == null ? void 0 : e3.keychain), this.history = new Vt(this, this.logger), this.expirer = new qt2(this, this.logger), this.storage = e3 != null && e3.storage ? e3.storage : new h3(Jt2(Jt2({}, Ze2), e3 == null ? void 0 : e3.storageOptions)), this.relayer = new $t({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Bt2(this, this.logger), this.verify = new jt(this.projectId || "", this.logger), this.echoClient = new Gt2(this.projectId || "", this.logger);
  }
  static async init(e3) {
    const t3 = new _te(e3);
    await t3.initialize();
    const i5 = await t3.crypto.getClientId();
    return await t3.storage.setItem(yt2, i5), t3;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var ue3 = (w8, r3, e3) => r3 in w8 ? as2(w8, r3, { enumerable: true, configurable: true, writable: true, value: e3 }) : w8[r3] = e3;
var g6 = (w8, r3) => {
  for (var e3 in r3 || (r3 = {}))
    ps2.call(r3, e3) && ue3(w8, e3, r3[e3]);
  if (de3)
    for (var e3 of de3(r3))
      hs2.call(r3, e3) && ue3(w8, e3, r3[e3]);
  return w8;
};
var D6 = (w8, r3) => cs2(w8, ls2(r3));
var ds2 = class extends w7 {
  constructor(r3) {
    super(r3), this.name = le3, this.events = new import_events8.default(), this.initialized = false, this.ignoredPayloadTypes = [_5], this.requestQueue = { state: I3.idle, queue: [] }, this.sessionRequestQueue = { state: I3.idle, queue: [] }, this.requestQueueDelay = import_time4.ONE_SECOND, this.init = async () => {
      this.initialized || (await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.registerPairingEvents(), this.client.core.pairing.register({ methods: Object.keys(R4) }), this.initialized = true, setTimeout(() => {
        this.sessionRequestQueue.queue = this.getPendingSessionRequests(), this.processSessionRequestQueue();
      }, (0, import_time4.toMiliseconds)(this.requestQueueDelay)));
    }, this.connect = async (e3) => {
      await this.isInitialized();
      const s3 = D6(g6({}, e3), { requiredNamespaces: e3.requiredNamespaces || {}, optionalNamespaces: e3.optionalNamespaces || {} });
      await this.isValidConnect(s3);
      const { pairingTopic: t3, requiredNamespaces: i5, optionalNamespaces: n3, sessionProperties: o3, relays: a5 } = s3;
      let c6 = t3, p5, d4 = false;
      if (c6 && (d4 = this.client.core.pairing.pairings.get(c6).active), !c6 || !d4) {
        const { topic: T4, uri: _6 } = await this.client.core.pairing.create();
        c6 = T4, p5 = _6;
      }
      const h6 = await this.client.core.crypto.generateKeyPair(), N12 = R4.wc_sessionPropose.req.ttl || import_time4.FIVE_MINUTES, m4 = pt(N12), f4 = g6({ requiredNamespaces: i5, optionalNamespaces: n3, relays: a5 ?? [{ protocol: ht2 }], proposer: { publicKey: h6, metadata: this.client.metadata }, expiryTimestamp: m4 }, o3 && { sessionProperties: o3 }), { reject: k5, resolve: O5, done: we } = at(N12, ae2);
      if (this.events.once(yt("session_connect"), async ({ error: T4, session: _6 }) => {
        if (T4)
          k5(T4);
        else if (_6) {
          _6.self.publicKey = h6;
          const B4 = D6(g6({}, _6), { requiredNamespaces: f4.requiredNamespaces, optionalNamespaces: f4.optionalNamespaces });
          await this.client.session.set(_6.topic, B4), await this.setExpiry(_6.topic, _6.expiry), c6 && await this.client.core.pairing.updateMetadata({ topic: c6, metadata: _6.peer.metadata }), O5(B4);
        }
      }), !c6) {
        const { message: T4 } = N10("NO_MATCHING_KEY", `connect() pairing topic: ${c6}`);
        throw new Error(T4);
      }
      const W4 = await this.sendRequest({ topic: c6, method: "wc_sessionPropose", params: f4, throwOnFailedPublish: true });
      ...
      const { id: s3, relayProtocol: t3, namespaces: i5, sessionProperties: n3 } = e3, o3 = this.client.proposal.get(s3);
      let { pairingTopic: a5, proposer: c6, requiredNamespaces: p5, optionalNamespaces: d4 } = o3;
      a5 = a5 || "";
      const h6 = await this.client.core.crypto.generateKeyPair(), N12 = c6.publicKey, m4 = await this.client.core.crypto.generateSharedKey(h6, N12);
      a5 && s3 && (await this.client.core.pairing.updateMetadata({ topic: a5, metadata: c6.metadata }), await this.sendResult({ id: s3, topic: a5, result: { relay: { protocol: t3 ?? "irn" }, responderPublicKey: h6 } }), await this.client.proposal.delete(s3, U2("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a5 }));
      const f4 = g6({ relay: { protocol: t3 ?? "irn" }, namespaces: i5, pairingTopic: a5, controller: { publicKey: h6, metadata: this.client.metadata }, expiry: pt(L5) }, n3 && { sessionProperties: n3 });
      await this.client.core.relayer.subscribe(m4);
      const k5 = D6(g6({}, f4), { topic: m4, requiredNamespaces: p5, optionalNamespaces: d4, pairingTopic: a5, acknowledged: false, self: f4.controller, peer: { publicKey: c6.publicKey, metadata: c6.metadata }, controller: h6 });
      await this.client.session.set(m4, k5);
      try {
        await this.sendRequest({ topic: m4, method: "wc_sessionSettle", params: f4, throwOnFailedPublish: true });
      } catch (O5) {
        throw this.client.logger.error(O5), this.client.session.delete(m4, U2("USER_DISCONNECTED")), await this.client.core.relayer.unsubscribe(m4), O5;
      }
      return await this.setExpiry(m4, pt(L5)), { topic: m4, acknowledged: () => new Promise((O5) => setTimeout(() => O5(this.client.session.get(m4)), 500)) };
    }, this.reject = async (e3) => {
      await this.isInitialized(), await this.isValidReject(e3);
      const { id: s3, reason: t3 } = e3, { pairingTopic: i5 } = this.client.proposal.get(s3);
      i5 && (await this.sendError(s3, i5, t3), await this.client.proposal.delete(s3, U2("USER_DISCONNECTED")));
    }, this.update = async (e3) => {
      await this.isInitialized(), await this.isValidUpdate(e3);
      const { topic: s3, namespaces: t3 } = e3, i5 = await this.sendRequest({ topic: s3, method: "wc_sessionUpdate", params: { namespaces: t3 } }), { done: n3, resolve: o3, reject: a5 } = at();
      return this.events.once(yt("session_update", i5), ({ error: c6 }) => {
        c6 ? a5(c6) : o3();
      ...
      const { topic: s3 } = e3, t3 = await this.sendRequest({ topic: s3, method: "wc_sessionExtend", params: {} }), { done: i5, resolve: n3, reject: o3 } = at();
      return this.events.once(yt("session_extend", t3), ({ error: a5 }) => {
        a5 ? o3(a5) : n3();
      }), await this.setExpiry(s3, pt(L5)), { acknowledged: i5 };
    }, this.request = async (e3) => {
      await this.isInitialized(), await this.isValidRequest(e3);
      const { chainId: s3, request: t3, topic: i5, expiry: n3 = R4.wc_sessionRequest.req.ttl } = e3, o3 = payloadId(), { done: a5, resolve: c6, reject: p5 } = at(n3, "Request expired. Please try again.");
      return this.events.once(yt("session_request", o3), ({ error: d4, result: h6 }) => {
        d4 ? p5(d4) : c6(h6);
      }), await Promise.all([new Promise(async (d4) => {
        await this.sendRequest({ clientRpcId: o3, topic: i5, method: "wc_sessionRequest", params: { request: D6(g6({}, t3), { expiryTimestamp: pt(n3) }), chainId: s3 }, expiry: n3, throwOnFailedPublish: true }).catch((h6) => p5(h6)), this.client.events.emit("session_request_sent", { topic: i5, request: t3, chainId: s3, id: o3 }), d4();
      }), new Promise(async (d4) => {
        const h6 = await ht(this.client.core.storage, H4);
        gt({ id: o3, topic: i5, wcDeepLink: h6 }), d4();
      }), a5()]).then((d4) => d4[2]);
    }, this.respond = async (e3) => {
      await this.isInitialized(), await this.isValidRespond(e3);
      const { topic: s3, response: t3 } = e3, { id: i5 } = t3;
      isJsonRpcResult(t3) ? await this.sendResult({ id: i5, topic: s3, result: t3.result, throwOnFailedPublish: true }) : isJsonRpcError(t3) && await this.sendError(i5, s3, t3.error), this.cleanupAfterResponse(e3);
    }, this.ping = async (e3) => {
      await this.isInitialized(), await this.isValidPing(e3);
      const { topic: s3 } = e3;
      if (this.client.session.keys.includes(s3)) {
        const t3 = await this.sendRequest({ topic: s3, method: "wc_sessionPing", params: {} }), { done: i5, resolve: n3, reject: o3 } = at();
      ...
      const { topic: s3, event: t3, chainId: i5 } = e3;
      await this.sendRequest({ topic: s3, method: "wc_sessionEvent", params: { event: t3, chainId: i5 } });
    }, this.disconnect = async (e3) => {
      await this.isInitialized(), await this.isValidDisconnect(e3);
      const { topic: s3 } = e3;
      if (this.client.session.keys.includes(s3))
        await this.sendRequest({ topic: s3, method: "wc_sessionDelete", params: U2("USER_DISCONNECTED"), throwOnFailedPublish: true }), await this.deleteSession({ topic: s3, emitEvent: false });
    ...
    }, this.find = (e3) => (this.isInitialized(), this.client.session.getAll().filter((s3) => Mt(s3, e3))), this.getPendingSessionRequests = () => this.client.pendingRequest.getAll(), this.cleanupDuplicatePairings = async (e3) => {
      if (e3.pairingTopic)
        try {
          const s3 = this.client.core.pairing.pairings.get(e3.pairingTopic), t3 = this.client.core.pairing.pairings.getAll().filter((i5) => {
            var n3, o3;
            return ((n3 = i5.peerMetadata) == null ? void 0 : n3.url) && ((o3 = i5.peerMetadata) == null ? void 0 : o3.url) === e3.peer.metadata.url && i5.topic && i5.topic !== s3.topic;
          });
          if (t3.length === 0)
            return;
          this.client.logger.info(`Cleaning up ${t3.length} duplicate pairing(s)`), await Promise.all(t3.map((i5) => this.client.core.pairing.disconnect({ topic: i5.topic }))), this.client.logger.info("Duplicate pairings clean up finished");
        } catch (s3) {
          this.client.logger.error(s3);
        }
    }, this.deleteSession = async (e3) => {
      const { topic: s3, expirerHasDeleted: t3 = false, emitEvent: i5 = true, id: n3 = 0 } = e3, { self: o3 } = this.client.session.get(s3);
      await this.client.core.relayer.unsubscribe(s3), await this.client.session.delete(s3, U2("USER_DISCONNECTED")), this.client.core.crypto.keychain.has(o3.publicKey) && await this.client.core.crypto.deleteKeyPair(o3.publicKey), this.client.core.crypto.keychain.has(s3) && await this.client.core.crypto.deleteSymKey(s3), t3 || this.client.core.expirer.del(s3), this.client.core.storage.removeItem(H4).catch((a5) => this.client.logger.warn(a5)), this.getPendingSessionRequests().forEach((a5) => {
        a5.topic === s3 && this.deletePendingSessionRequest(a5.id, U2("USER_DISCONNECTED"));
      }), i5 && this.client.events.emit("session_delete", { id: n3, topic: s3 });
      ...
      await Promise.all([this.client.pendingRequest.delete(e3, s3), t3 ? Promise.resolve() : this.client.core.expirer.del(e3)]), this.sessionRequestQueue.queue = this.sessionRequestQueue.queue.filter((i5) => i5.id !== e3), t3 && (this.sessionRequestQueue.state = I3.idle, this.client.events.emit("session_request_expire", { id: e3 }));
      ...
      await this.client.proposal.set(e3, s3), this.client.core.expirer.set(e3, pt(R4.wc_sessionPropose.req.ttl));
    }, this.setPendingSessionRequest = async (e3) => {
      const { id: s3, topic: t3, params: i5, verifyContext: n3 } = e3, o3 = i5.request.expiryTimestamp || pt(R4.wc_sessionRequest.req.ttl);
      await this.client.pendingRequest.set(s3, { id: s3, topic: t3, params: i5, verifyContext: n3 }), o3 && this.client.core.expirer.set(s3, o3);
    }, this.sendRequest = async (e3) => {
      const { topic: s3, method: t3, params: i5, expiry: n3, relayRpcId: o3, clientRpcId: a5, throwOnFailedPublish: c6 } = e3, p5 = formatJsonRpcRequest(t3, i5, a5);
      if (D4() && he3.includes(t3)) {
        const N12 = Ln(JSON.stringify(p5));
        this.client.core.verify.register({ attestationId: N12 });
      }
      const d4 = await this.client.core.crypto.encode(s3, p5), h6 = R4[t3].req;
      return n3 && (h6.ttl = n3), o3 && (h6.id = o3), this.client.core.history.set(s3, p5), c6 ? (h6.internal = D6(g6({}, h6.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s3, d4, h6)) : this.client.core.relayer.publish(s3, d4, h6).catch((N12) => this.client.logger.error(N12)), p5.id;
    }, this.sendResult = async (e3) => {
      const { id: s3, topic: t3, result: i5, throwOnFailedPublish: n3 } = e3, o3 = formatJsonRpcResult(s3, i5), a5 = await this.client.core.crypto.encode(t3, o3), c6 = await this.client.core.history.get(t3, s3), p5 = R4[c6.request.method].res;
      n3 ? (p5.internal = D6(g6({}, p5.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(t3, a5, p5)) : this.client.core.relayer.publish(t3, a5, p5).catch((d4) => this.client.logger.error(d4)), await this.client.core.history.resolve(o3);
    }, this.sendError = async (e3, s3, t3) => {
      const i5 = formatJsonRpcError(e3, t3), n3 = await this.client.core.crypto.encode(s3, i5), o3 = await this.client.core.history.get(s3, e3), a5 = R4[o3.request.method].res;
      this.client.core.relayer.publish(s3, n3, a5), await this.client.core.history.resolve(i5);
    }, this.cleanup = async () => {
      const e3 = [], s3 = [];
      this.client.session.getAll().forEach((t3) => {
        let i5 = false;
        mt(t3.expiry) && (i5 = true), this.client.core.crypto.keychain.has(t3.topic) || (i5 = true), i5 && e3.push(t3.topic);
      }), this.client.proposal.getAll().forEach((t3) => {
        mt(t3.expiryTimestamp) && s3.push(t3.id);
      }), await Promise.all([...e3.map((t3) => this.deleteSession({ topic: t3 })), ...s3.map((t3) => this.deleteProposal(t3))]);
      ...
      const { topic: s3, payload: t3 } = e3, i5 = t3.method;
      switch (i5) {
        ...
        default:
          return this.client.logger.info(`Unsupported request method ${i5}`);
      }
    }, this.onRelayEventResponse = async (e3) => {
      const { topic: s3, payload: t3 } = e3, i5 = (await this.client.core.history.get(s3, t3.id)).request.method;
      switch (i5) {
        case "wc_sessionPropose":
        ...
        default:
          return this.client.logger.info(`Unsupported response method ${i5}`);
      }
      ...
      const { params: t3, id: i5 } = s3;
      try {
        this.isValidConnect(g6({}, s3.params));
        const n3 = t3.expiryTimestamp || pt(R4.wc_sessionPropose.req.ttl), o3 = g6({ id: i5, pairingTopic: e3, expiryTimestamp: n3 }, t3);
        await this.setProposal(i5, o3);
        const a5 = Ln(JSON.stringify(s3)), c6 = await this.getVerifyContext(a5, o3.proposer.metadata);
        this.client.events.emit("session_proposal", { id: i5, params: o3, verifyContext: c6 });
      } catch (n3) {
        await this.sendError(i5, e3, n3), this.client.logger.error(n3);
      }
    }, this.onSessionProposeResponse = async (e3, s3) => {
      const { id: t3 } = s3;
      if (isJsonRpcResult(s3)) {
        const { result: i5 } = s3;
        this.client.logger.trace({ type: "method", method: "onSessionProposeResponse", result: i5 });
        ...
        isJsonRpcError(s3) && (await this.client.proposal.delete(t3, U2("USER_DISCONNECTED")), this.events.emit(yt("session_connect"), { error: s3.error }));
    }, this.onSessionSettleRequest = async (e3, s3) => {
      const { id: t3, params: i5 } = s3;
      try {
        this.isValidSessionSettleRequest(i5);
        const { relay: n3, controller: o3, expiry: a5, namespaces: c6, sessionProperties: p5, pairingTopic: d4 } = s3.params, h6 = g6({ topic: e3, relay: n3, expiry: a5, namespaces: c6, acknowledged: true, pairingTopic: d4, requiredNamespaces: {}, optionalNamespaces: {}, controller: o3.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o3.publicKey, metadata: o3.metadata } }, p5 && { sessionProperties: p5 });
        await this.sendResult({ id: s3.id, topic: e3, result: true }), this.events.emit(yt("session_connect"), { session: h6 }), this.cleanupDuplicatePairings(h6);
      } catch (n3) {
        await this.sendError(t3, e3, n3), this.client.logger.error(n3);
      }
    }, this.onSessionSettleResponse = async (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? (await this.client.session.update(e3, { acknowledged: true }), this.events.emit(yt("session_approve", t3), {})) : isJsonRpcError(s3) && (await this.client.session.delete(e3, U2("USER_DISCONNECTED")), this.events.emit(yt("session_approve", t3), { error: s3.error }));
    }, this.onSessionUpdateRequest = async (e3, s3) => {
      const { params: t3, id: i5 } = s3;
      try {
        const n3 = `${e3}_session_update`, o3 = sr.get(n3);
        if (o3 && this.isRequestOutOfSync(o3, i5)) {
          this.client.logger.info(`Discarding out of sync request - ${i5}`);
          return;
        }
        this.isValidUpdate(g6({ topic: e3 }, t3)), await this.client.session.update(e3, { namespaces: t3.namespaces }), await this.sendResult({ id: i5, topic: e3, result: true }), this.client.events.emit("session_update", { id: i5, topic: e3, params: t3 }), sr.set(n3, i5);
      } catch (n3) {
        await this.sendError(i5, e3, n3), this.client.logger.error(n3);
      }
      ...
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? this.events.emit(yt("session_update", t3), {}) : isJsonRpcError(s3) && this.events.emit(yt("session_update", t3), { error: s3.error });
    }, this.onSessionExtendRequest = async (e3, s3) => {
      const { id: t3 } = s3;
      try {
        this.isValidExtend({ topic: e3 }), await this.setExpiry(e3, pt(L5)), await this.sendResult({ id: t3, topic: e3, result: true }), this.client.events.emit("session_extend", { id: t3, topic: e3 });
      } catch (i5) {
        await this.sendError(t3, e3, i5), this.client.logger.error(i5);
      }
    }, this.onSessionExtendResponse = (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? this.events.emit(yt("session_extend", t3), {}) : isJsonRpcError(s3) && this.events.emit(yt("session_extend", t3), { error: s3.error });
      ...
      const { id: t3 } = s3;
      setTimeout(() => {
        isJsonRpcResult(s3) ? this.events.emit(yt("session_ping", t3), {}) : isJsonRpcError(s3) && this.events.emit(yt("session_ping", t3), { error: s3.error });
      }, 500);
    }, this.onSessionDeleteRequest = async (e3, s3) => {
      const { id: t3 } = s3;
      try {
        this.isValidDisconnect({ topic: e3, reason: s3.params }), await Promise.all([new Promise((i5) => {
          this.client.core.relayer.once(D5.publish, async () => {
            i5(await this.deleteSession({ topic: e3, id: t3 }));
          });
        }), this.sendResult({ id: t3, topic: e3, result: true }), this.cleanupPendingSentRequestsForTopic({ topic: e3, error: U2("USER_DISCONNECTED") })]);
      } catch (i5) {
      ...
      const { id: t3, params: i5 } = s3;
      try {
        this.isValidRequest(g6({ topic: e3 }, i5));
        const n3 = Ln(JSON.stringify(formatJsonRpcRequest("wc_sessionRequest", i5, t3))), o3 = this.client.session.get(e3), a5 = await this.getVerifyContext(n3, o3.peer.metadata), c6 = { id: t3, topic: e3, params: i5, verifyContext: a5 };
        await this.setPendingSessionRequest(c6), this.addSessionRequestToSessionRequestQueue(c6), this.processSessionRequestQueue();
      } catch (n3) {
        await this.sendError(t3, e3, n3), this.client.logger.error(n3);
      }
    }, this.onSessionRequestResponse = (e3, s3) => {
      const { id: t3 } = s3;
      isJsonRpcResult(s3) ? this.events.emit(yt("session_request", t3), { result: s3.result }) : isJsonRpcError(s3) && this.events.emit(yt("session_request", t3), { error: s3.error });
    }, this.onSessionEventRequest = async (e3, s3) => {
      const { id: t3, params: i5 } = s3;
      try {
        const n3 = `${e3}_session_event_${i5.event.name}`, o3 = sr.get(n3);
        if (o3 && this.isRequestOutOfSync(o3, t3)) {
          this.client.logger.info(`Discarding out of sync request - ${t3}`);
          return;
        }
        this.isValidEmit(g6({ topic: e3 }, i5)), this.client.events.emit("session_event", { id: t3, topic: e3, params: i5 }), sr.set(n3, t3);
      } catch (n3) {
        await this.sendError(t3, e3, n3), this.client.logger.error(n3);
      }
      ...
      t3.length > 0 && t3.filter((i5) => i5.topic === e3 && i5.request.method === "wc_sessionRequest").forEach((i5) => {
        this.events.emit(yt("session_request", i5.request.id), { error: s3 });
      });
      ...
      s3 && this.onSessionProposeRequest(e3.topic, formatJsonRpcRequest("wc_sessionPropose", { requiredNamespaces: s3.requiredNamespaces, optionalNamespaces: s3.optionalNamespaces, relays: s3.relays, proposer: s3.proposer, sessionProperties: s3.sessionProperties }, s3.id));
    }, this.isValidConnect = async (e3) => {
      if (!Gt(e3)) {
        const { message: a5 } = N10("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(e3)}`);
        throw new Error(a5);
      }
      const { pairingTopic: s3, requiredNamespaces: t3, optionalNamespaces: i5, sessionProperties: n3, relays: o3 } = e3;
      if (w4(s3) || await this.isValidPairingTopic(s3), !qt(o3, true)) {
        const { message: a5 } = N10("MISSING_OR_INVALID", `connect() relays: ${o3}`);
        throw new Error(a5);
      }
      !w4(t3) && B2(t3) !== 0 && this.validateNamespaces(t3, "requiredNamespaces"), !w4(i5) && B2(i5) !== 0 && this.validateNamespaces(i5, "optionalNamespaces"), w4(n3) || this.validateSessionProps(n3, "sessionProperties");
      ...
      const { id: s3, namespaces: t3, relayProtocol: i5, sessionProperties: n3 } = e3;
      await this.isValidProposalId(s3);
      const o3 = this.client.proposal.get(s3), a5 = ln(t3, "approve()");
      if (a5)
        throw new Error(a5.message);
      const c6 = fn(o3.requiredNamespaces, t3, "approve()");
      if (c6)
        throw new Error(c6.message);
      if (!g4(i5, true)) {
        const { message: p5 } = N10("MISSING_OR_INVALID", `approve() relayProtocol: ${i5}`);
        throw new Error(p5);
      }
      w4(n3) || this.validateSessionProps(n3, "sessionProperties");
    }, this.isValidReject = async (e3) => {
      if (!Gt(e3)) {
        const { message: i5 } = N10("MISSING_OR_INVALID", `reject() params: ${e3}`);
        throw new Error(i5);
      }
      const { id: s3, reason: t3 } = e3;
      if (await this.isValidProposalId(s3), !Wt(t3)) {
        const { message: i5 } = N10("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(t3)}`);
        throw new Error(i5);
      }
    }, this.isValidSessionSettleRequest = (e3) => {
      if (!Gt(e3)) {
        const { message: c6 } = N10("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${e3}`);
        throw new Error(c6);
      }
      const { relay: s3, controller: t3, namespaces: i5, expiry: n3 } = e3;
      if (!dn(s3)) {
        const { message: c6 } = N10("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
        throw new Error(c6);
      }
      const o3 = Ft(t3, "onSessionSettleRequest()");
      if (o3)
        throw new Error(o3.message);
      const a5 = ln(i5, "onSessionSettleRequest()");
      if (a5)
        throw new Error(a5.message);
      if (mt(n3)) {
        const { message: c6 } = N10("EXPIRED", "onSessionSettleRequest()");
        throw new Error(c6);
      }
      ...
      const i5 = this.client.session.get(s3), n3 = ln(t3, "update()");
      if (n3)
        throw new Error(n3.message);
      const o3 = fn(i5.requiredNamespaces, t3, "update()");
      if (o3)
        throw new Error(o3.message);
      ...
      const { topic: s3, request: t3, chainId: i5, expiry: n3 } = e3;
      await this.isValidSessionTopic(s3);
      const { namespaces: o3 } = this.client.session.get(s3);
      if (!Qt(o3, i5)) {
        const { message: a5 } = N10("MISSING_OR_INVALID", `request() chainId: ${i5}`);
        throw new Error(a5);
      }
      if (!zt(t3)) {
      ...
      if (!Zt(o3, i5, t3.method)) {
        const { message: a5 } = N10("MISSING_OR_INVALID", `request() method: ${t3.method}`);
        throw new Error(a5);
      }
      if (n3 && !tr(n3, U4)) {
        const { message: a5 } = N10("MISSING_OR_INVALID", `request() expiry: ${n3}. Expiry must be a number (in seconds) between ${U4.min} and ${U4.max}`);
        throw new Error(a5);
      }
      ...
      const { topic: t3, response: i5 } = e3;
      try {
        await this.isValidSessionTopic(t3);
      } catch (n3) {
        throw (s3 = e3 == null ? void 0 : e3.response) != null && s3.id && this.cleanupAfterResponse(e3), n3;
      }
      if (!Yt(i5)) {
        const { message: n3 } = N10("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(i5)}`);
        throw new Error(n3);
      }
      ...
      if (!Qt(n3, i5)) {
        const { message: o3 } = N10("MISSING_OR_INVALID", `emit() chainId: ${i5}`);
        throw new Error(o3);
      }
      if (!Jt(t3)) {
      ...
      try {
        const i5 = await this.client.core.verify.resolve({ attestationId: e3, verifyUrl: s3.verifyUrl });
        i5 && (t3.verified.origin = i5.origin, t3.verified.isScam = i5.isScam, t3.verified.validation = i5.origin === new URL(s3.url).origin ? "VALID" : "INVALID");
      } catch (i5) {
        this.client.logger.info(i5);
      }
      ...
      Object.values(e3).forEach((t3) => {
        if (!g4(t3, false)) {
          const { message: i5 } = N10("MISSING_OR_INVALID", `${s3} must be in Record<string, string> format. Received: ${JSON.stringify(t3)}`);
          throw new Error(i5);
        }
      });
    };
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(v4.expired, async (r3) => {
      ...
      e3 ? this.client.session.keys.includes(e3) && (await this.deleteSession({ topic: e3, expirerHasDeleted: true }), this.client.events.emit("session_expire", { topic: e3 })) : s3 && (await this.deleteProposal(s3, true), this.client.events.emit("proposal_expire", { id: s3 }));
    });
  }
...
var Q4 = class _Q extends b4 {
  constructor(r3) {
    ...
    }, this.name = (r3 == null ? void 0 : r3.name) || M4.name, this.metadata = (r3 == null ? void 0 : r3.metadata) || Qn();
    ...
    this.core = (r3 == null ? void 0 : r3.core) || new Mr(r3), this.logger = (0, import_logger2.generateChildLogger)(e3, this.name), this.session = new ge3(this.core, this.logger), this.proposal = new us2(this.core, this.logger), this.pendingRequest = new gs2(this.core, this.logger), this.engine = new ds2(this);
  }
...
var WalletConnectWallet = class {
  ...
  get publicKey() {
    if (this._client && this._session) {
      const { address } = z4(this._session.namespaces.solana.accounts[0]);
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=esm-TWYRJ262.js.map
