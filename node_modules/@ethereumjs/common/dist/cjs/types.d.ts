...
export interface CustomCrypto {
    ...
    ecdsaSign?: (msg: Uint8Array, pk: Uint8Array) => {
...
declare type ParamDict = {
    v: number | bigint | null;
    d: string;
};
export declare type EIPOrHFConfig = {
    comment: string;
    url: string;
    status: string;
    gasConfig?: {
...
export declare type EIPConfig = {
    minimumHardfork: Hardfork;
    requiredEIPs: number[];
} & EIPOrHFConfig;
export declare type HardforkConfig = {
    name: string;
    eips?: number[];
    consensus?: ConsensusConfig;
} & EIPOrHFConfig;
